...
<h2 id="date-命令" tabindex="-1"><a class="header-anchor" href="#date-命令" aria-hidden="true">#</a> date 命令</h2>
<p><code v-pre>date</code> 命令用于输出当前时间</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ <span class="token function">date</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ <span class="token function">date</span> +%d_%b_%Y
10_Sep_2018
...
<h2 id="cal-命令" tabindex="-1"><a class="header-anchor" href="#cal-命令" aria-hidden="true">#</a> cal 命令</h2>
<p><code v-pre>cal</code> 命令用于显示日历。不带有参数时，显示的是当前月份。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ <span class="token function">cal</span>
