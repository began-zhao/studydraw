<template><div><h1 id="nl" tabindex="-1"><a class="header-anchor" href="#nl" aria-hidden="true">#</a> nl</h1>
<p><code v-pre>nl</code> 命令用于显示行号。</p>
<p>下面是 <code v-pre>example.txt</code> 文件的内容。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>Lorem ipsum
dolor sit amet,
consetetur
sadipscing elitr,
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>$ <span class="token function">nl</span> -s<span class="token string">". "</span> example.txt
