<template><div><h2 id="session" tabindex="-1"><a class="header-anchor" href="#session" aria-hidden="true">#</a> Session</h2>
<p>用户每次使用 Shell，都会开启一个与 Shell 的 Session(对话)。</p>
<p>Session 有两种类型: 登录 Session 和非登录 Session，也可以叫做 login shell 和 non-login shell。</p>
<h3 id="登录-session" tabindex="-1"><a class="header-anchor" href="#登录-session" aria-hidden="true">#</a> 登录 Session</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># .bash_profile</span>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">bash</span> --login
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">bash</span> --noprofile
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="非登录-session" tabindex="-1"><a class="header-anchor" href="#非登录-session" aria-hidden="true">#</a> 非登录 Session</h3>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">bash</span> --norc
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">bash</span> --rcfile testrc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="bash-logout" tabindex="-1"><a class="header-anchor" href="#bash-logout" aria-hidden="true">#</a> .bash_logout</h3>
...
<h2 id="启动选项" tabindex="-1"><a class="header-anchor" href="#启动选项" aria-hidden="true">#</a> 启动选项</h2>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">bash</span> -n scriptname
<span class="token function">bash</span> -v scriptname
<span class="token function">bash</span> -x scriptname
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="键盘绑定" tabindex="-1"><a class="header-anchor" href="#键盘绑定" aria-hidden="true">#</a> 键盘绑定</h2>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token variable">$include</span> /etc/inputrc
