<template><div><h2 id="touch-命令" tabindex="-1"><a class="header-anchor" href="#touch-命令" aria-hidden="true">#</a> touch 命令</h2>
...
<h2 id="ln-命令" tabindex="-1"><a class="header-anchor" href="#ln-命令" aria-hidden="true">#</a> ln 命令</h2>
...
<h3 id="ln-扩展介绍" tabindex="-1"><a class="header-anchor" href="#ln-扩展介绍" aria-hidden="true">#</a> ln 扩展介绍</h3>
<ul>
<li><RouterLink to="/linux/command/ln.html">点击前往</RouterLink></li>
</ul>
</div></template>
