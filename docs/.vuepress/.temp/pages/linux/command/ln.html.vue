...
<!-- more -->
<h2 id="ln-创建硬链接" tabindex="-1"><a class="header-anchor" href="#ln-创建硬链接" aria-hidden="true">#</a> ln 创建硬链接</h2>
...
<p><img src="@source/linux/assets/hardlink.jpg" alt="Hardlink" loading="lazy"></p>
...
<h2 id="ln-创建软链接" tabindex="-1"><a class="header-anchor" href="#ln-创建软链接" aria-hidden="true">#</a> ln 创建软链接</h2>
...
<p><img src="@source/linux/assets/softlink.jpg" alt="软链接示意图" loading="lazy"></p>
