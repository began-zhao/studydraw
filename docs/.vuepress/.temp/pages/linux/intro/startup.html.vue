<template><div><h1 id="linux-系统启动过程" tabindex="-1"><a class="header-anchor" href="#linux-系统启动过程" aria-hidden="true">#</a> Linux 系统启动过程</h1>
...
<h2 id="内核引导" tabindex="-1"><a class="header-anchor" href="#内核引导" aria-hidden="true">#</a> 内核引导</h2>
<p>当计算机打开电源后，首先是 BIOS 开机自检，按照 BIOS 中设置的启动设备(通常是硬盘)来启动。</p>
<p>操作系统接管硬件以后，首先读入 <code v-pre>/boot</code> 目录下的内核文件。</p>
<p><img src="@source/linux/assets/boot.png" alt="boot" loading="lazy"></p>
<h2 id="运行-init" tabindex="-1"><a class="header-anchor" href="#运行-init" aria-hidden="true">#</a> 运行 init</h2>
<p>init 进程是系统所有进程的起点，您可以把它比拟成系统所有进程的老祖宗，没有这个进程，系统中任何进程都不会启动。</p>
<p>init 程序首先是需要读取配置文件 <code v-pre>/etc/inittab</code>。</p>
<p><img src="@source/linux/assets/init.png" alt="init" loading="lazy"></p>
<h3 id="运行级别" tabindex="-1"><a class="header-anchor" href="#运行级别" aria-hidden="true">#</a> 运行级别</h3>
...
<p><img src="@source/linux/assets/runlevel.png" alt="runlevel" loading="lazy"></p>
...
<h2 id="系统初始化" tabindex="-1"><a class="header-anchor" href="#系统初始化" aria-hidden="true">#</a> 系统初始化</h2>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>l5:5:wait:/etc/rc.d/rc <span class="token number">5</span>
