...
<p>为什么不选择 C 语言呢?</p>
<h2 id="c-语言并不是最佳选择" tabindex="-1"><a class="header-anchor" href="#c-语言并不是最佳选择" aria-hidden="true">#</a> C 语言并不是最佳选择</h2>
...
<h2 id="脚本语言也有不足" tabindex="-1"><a class="header-anchor" href="#脚本语言也有不足" aria-hidden="true">#</a> 脚本语言也有不足</h2>
