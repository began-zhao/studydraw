...
<h2 id="linux-的发行版" tabindex="-1"><a class="header-anchor" href="#linux-的发行版" aria-hidden="true">#</a> Linux 的发行版</h2>
<p>Linux 的发行版说简单点就是将 Linux 内核与应用软件做一个打包。</p>
<p><img src="@source/linux/assets/intro.jpg" alt="intro" loading="lazy"></p>
...
<h3 id="gentoo" tabindex="-1"><a class="header-anchor" href="#gentoo" aria-hidden="true">#</a> Gentoo</h3>
