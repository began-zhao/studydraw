<template><div><h1 id="计算机网络面试突击" tabindex="-1"><a class="header-anchor" href="#计算机网络面试突击" aria-hidden="true">#</a> 计算机网络面试突击</h1>
<h2 id="一-各协议层以及它们的服务类型" tabindex="-1"><a class="header-anchor" href="#一-各协议层以及它们的服务类型" aria-hidden="true">#</a> 一：各协议层以及它们的服务类型</h2>
<h3 id="_1-osi-七层模型" tabindex="-1"><a class="header-anchor" href="#_1-osi-七层模型" aria-hidden="true">#</a> 1. OSI 七层模型</h3>
<p><img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8cad8cadf67e482696231599f834aa81~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"> OSI 模型全称为开放式通信系统互连参考模型，是国际标准化组织 ( ISO ) 提出的一个试图使各种计算机在世界范围内互连为网络的标准框架。 OSI 将计算机网络体系结构划分为七层，每一层实现各自的功能和协议，并完成与相邻层的接口通信。OSI 的服务定义详细说明了各层所提供的服务。某一层的服务就是该层及其下各层的一种能力，它通过接口提供给更高一层。各层所提供的服务与这些服务是怎么实现的无关。</p>
<p>① 应用层</p>
...
<h3 id="_2-tcp-ip-参考模型" tabindex="-1"><a class="header-anchor" href="#_2-tcp-ip-参考模型" aria-hidden="true">#</a> 2. TCP/IP 参考模型</h3>
...
<h3 id="_3-tcp-ip-五层参考模型" tabindex="-1"><a class="header-anchor" href="#_3-tcp-ip-五层参考模型" aria-hidden="true">#</a> 3. TCP/IP 五层参考模型</h3>
...
<h3 id="_4-osi-模型和-tcp-ip-模型的异同比较" tabindex="-1"><a class="header-anchor" href="#_4-osi-模型和-tcp-ip-模型的异同比较" aria-hidden="true">#</a> 4. OSI 模型和 TCP/IP 模型的异同比较</h3>
<p>相同点</p>
...
<h3 id="_5-osi-和-tcp-ip-协议之间对应关系" tabindex="-1"><a class="header-anchor" href="#_5-osi-和-tcp-ip-协议之间对应关系" aria-hidden="true">#</a> 5. OSI 和 TCP/IP 协议之间对应关系</h3>
<p><img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/269b01d866bc4d3bb4db983cc102c72a~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<h3 id="_6-为什么-icp-ip-去除了表示层和会话层" tabindex="-1"><a class="header-anchor" href="#_6-为什么-icp-ip-去除了表示层和会话层" aria-hidden="true">#</a> 6. 为什么 ICP/IP 去除了表示层和会话层</h3>
...
<h3 id="_7-数据如何在各层之间传输" tabindex="-1"><a class="header-anchor" href="#_7-数据如何在各层之间传输" aria-hidden="true">#</a> 7. 数据如何在各层之间传输</h3>
...
<h2 id="二-应用层" tabindex="-1"><a class="header-anchor" href="#二-应用层" aria-hidden="true">#</a> 二：应用层</h2>
<h3 id="_1-http-头部包含哪些信息" tabindex="-1"><a class="header-anchor" href="#_1-http-头部包含哪些信息" aria-hidden="true">#</a> 1. HTTP 头部包含哪些信息</h3>
<p>HTTP 头部本质上是一个传递额外重要信息的键值对。主要分为：通用头部，请求头部，响应头部和实体头部。</p>
<p><strong>通用头部</strong></p>
<p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f8b770232b8947b6aa7f6cfd90529281~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<p><strong>请求头部</strong></p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dae9893ab7ba4b14be5e26c2e90498b7~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<p><strong>响应头部</strong></p>
<p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3ffb1fa2a46544d0a5da0658d4dddf07~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<p><strong>实体头部</strong></p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/717e4a10362c4efb8dae4bd81a953c27~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<h3 id="_2-keep-alive-和非-keep-alive-区别-对服务器性能有影响吗" tabindex="-1"><a class="header-anchor" href="#_2-keep-alive-和非-keep-alive-区别-对服务器性能有影响吗" aria-hidden="true">#</a> 2. Keep-Alive 和非 Keep-Alive 区别，对服务器性能有影响吗</h3>
...
<p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/10194b7d0e304fd786bebda28fb69718~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
...
<h3 id="_3-http-长连接短连接使用场景是什么" tabindex="-1"><a class="header-anchor" href="#_3-http-长连接短连接使用场景是什么" aria-hidden="true">#</a> 3. HTTP 长连接短连接使用场景是什么</h3>
...
<h3 id="_4-怎么知道-http-的报文长度" tabindex="-1"><a class="header-anchor" href="#_4-怎么知道-http-的报文长度" aria-hidden="true">#</a> 4. 怎么知道 HTTP 的报文长度</h3>
...
<h3 id="_5-http-方法了解哪些" tabindex="-1"><a class="header-anchor" href="#_5-http-方法了解哪些" aria-hidden="true">#</a> 5. HTTP 方法了解哪些</h3>
<p>HTTP/1.0 定义了三种请求方法：GET, POST 和 HEAD 方法。</p>
<p>HTTP/1.1 增加了六种请求方法：OPTIONS, PUT, PATCH, DELETE, TRACE 和 CONNECT 方法。</p>
<p><img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1105df43f3da4ec0b5ff3f77cdf6e297~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<h3 id="_6-get-和-post-的区别" tabindex="-1"><a class="header-anchor" href="#_6-get-和-post-的区别" aria-hidden="true">#</a> 6. GET 和 POST 的区别</h3>
<ol>
...
<h3 id="_7-get-的长度限制是多少" tabindex="-1"><a class="header-anchor" href="#_7-get-的长度限制是多少" aria-hidden="true">#</a> 7. GET 的长度限制是多少</h3>
...
<h3 id="_8-http-与-https-的工作方式【建立连接的过程】" tabindex="-1"><a class="header-anchor" href="#_8-http-与-https-的工作方式【建立连接的过程】" aria-hidden="true">#</a> 8. HTTP 与 HTTPs 的工作方式【建立连接的过程】</h3>
<p>HTTP</p>
...
<h3 id="_9-https-和-http-的区别" tabindex="-1"><a class="header-anchor" href="#_9-https-和-http-的区别" aria-hidden="true">#</a> 9. HTTPS 和 HTTP 的区别</h3>
<ol>
...
<h3 id="_10-https-的加密方式" tabindex="-1"><a class="header-anchor" href="#_10-https-的加密方式" aria-hidden="true">#</a> 10. HTTPS 的加密方式</h3>
...
<h3 id="_11-客户端为什么信任第三方证书" tabindex="-1"><a class="header-anchor" href="#_11-客户端为什么信任第三方证书" aria-hidden="true">#</a> 11. 客户端为什么信任第三方证书</h3>
...
<h3 id="_12-http-是不保存状态的协议-如何保存用户状态" tabindex="-1"><a class="header-anchor" href="#_12-http-是不保存状态的协议-如何保存用户状态" aria-hidden="true">#</a> 12. HTTP 是不保存状态的协议,如何保存用户状态</h3>
<p>我们知道，假如某个特定的客户机在短时间内两次请求同一个对象，服务器并不会因为刚刚为该用户提供了该对象就不再做出反应，而是重新发送该对象，就像该服务器已经完全忘记不久之前所做过的事一样。因为一个 HTTP 服务器并不保存关于客户机的任何信息，所以我们说 HTTP 是一个无状态协议。</p>
<p>通常有两种解决方案：</p>
...
<h3 id="_13-状态码" tabindex="-1"><a class="header-anchor" href="#_13-状态码" aria-hidden="true">#</a> 13. 状态码</h3>
<p>HTTP 状态码由三个十进制数字组成，第一个数字定义了状态码的类型，后两个并没有起到分类的作用。HTTP 状态码共有 5 种类型： <img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3e82615c74cb403dbc7e1ac4ba5c9c5d~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<p>面试时针对状态码的常见问法：</p>
...
<h3 id="_14-http-1-1-和-http-1-0-的区别" tabindex="-1"><a class="header-anchor" href="#_14-http-1-1-和-http-1-0-的区别" aria-hidden="true">#</a> 14. HTTP/1.1 和 HTTP/1.0 的区别</h3>
<p>主要区别如下：</p>
...
<h3 id="_15-http-1-x-和-http-2-0-的区别" tabindex="-1"><a class="header-anchor" href="#_15-http-1-x-和-http-2-0-的区别" aria-hidden="true">#</a> 15. HTTP/1.X 和 HTTP/2.0 的区别</h3>
<ol>
...
<h3 id="_16-http-3-了解吗" tabindex="-1"><a class="header-anchor" href="#_16-http-3-了解吗" aria-hidden="true">#</a> 16. HTTP/3 了解吗</h3>
<p>HTTP/2 存在的问题</p>
...
<p>最后我们使用一张图来清晰的表示出 HTTP 协议的发展变化： <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1ef086415a1b455d98f8b4a74daff170~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<h3 id="_17-dns-的作用和原理" tabindex="-1"><a class="header-anchor" href="#_17-dns-的作用和原理" aria-hidden="true">#</a> 17. DNS 的作用和原理</h3>
<p>DNS</p>
...
<p>DNS 域名解析原理</p>
<p>DNS 采用了分布式的设计方案，其域名空间采用一种树形的层次结构： <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/86c84543fb6c40149ec721b5f015247d~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
...
<p>我们以一个例子来了解 DNS 的工作原理，假设主机 A（IP 地址为 <a href="http://abc.xyz.edu" target="_blank" rel="noopener noreferrer">abc.xyz.edu<ExternalLinkIcon/></a>） 想知道主机 B 的 IP 地址 （<a href="http://def.mn.edu" target="_blank" rel="noopener noreferrer">def.mn.edu<ExternalLinkIcon/></a>），如下图所示，主机 A 首先向它的本地 DNS 服务器发送一个 DNS 查询报文。该查询报文含有被转换的主机名 <a href="http://def.mn.edu" target="_blank" rel="noopener noreferrer">def.mn.edu<ExternalLinkIcon/></a>。本地 DNS 服务器将该报文转发到根 DNS 服务器，根 DNS 服务器注意到查询的 IP 地址前缀为 edu 后向本地 DNS 服务器返回负责 edu 的顶级域名服务器的 IP 地址列表。该本地 DNS 服务器则再次向这些 顶级域名服务器发送查询报文。该顶级域名服务器注意到 <a href="http://mn.edu" target="_blank" rel="noopener noreferrer">mn.edu<ExternalLinkIcon/></a> 的前缀，并用权威域名服务器的 IP 地址进行响应。通常情况下，顶级域名服务器并不总是知道每台主机的权威 DNS 服务器的 IP 地址，而只知道中间的某个服务器，该中间 DNS 服务器依次能找到用于相应主机的 IP 地址，我们假设中间经历了权威服务器 ① 和 ②，最后找到了负责 <a href="http://def.mn.edu" target="_blank" rel="noopener noreferrer">def.mn.edu<ExternalLinkIcon/></a> 的权威 DNS 服务器 ③，之后，本地 DNS 服务器直接向该服务器发送查询报文从而获得主机 B 的IP 地址。</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f6dba7c39fd1418aa3f8b007771b0953~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
...
<h3 id="_19-dns-为什么用-udp" tabindex="-1"><a class="header-anchor" href="#_19-dns-为什么用-udp" aria-hidden="true">#</a> 19. DNS 为什么用 UDP</h3>
<p>DNS 既使用 TCP 又使用 UDP。</p>
...
<h3 id="_20-怎么实现-dns-劫持" tabindex="-1"><a class="header-anchor" href="#_20-怎么实现-dns-劫持" aria-hidden="true">#</a> 20. 怎么实现 DNS 劫持</h3>
...
<h3 id="_21-socket-套接字有哪些" tabindex="-1"><a class="header-anchor" href="#_21-socket-套接字有哪些" aria-hidden="true">#</a> 21. socket() 套接字有哪些</h3>
...
<h3 id="_22-uri-统一资源标识符-和-url-统一资源定位符-之间的区别" tabindex="-1"><a class="header-anchor" href="#_22-uri-统一资源标识符-和-url-统一资源定位符-之间的区别" aria-hidden="true">#</a> 22. URI（统一资源标识符）和 URL（统一资源定位符）之间的区别</h3>
<p>URL，即统一资源定位符 (Uniform Resource Locator )，URL 其实就是我们平时上网时输入的网址，它标识一个互联网资源，并指定对其进行操作或获取该资源的方法。例如 <a href="https://link.juejin.cn/?target=https%3A%2F%2Fleetcode-cn.com%2Fproblemset%2Fall%2F" target="_blank" rel="noopener noreferrer">leetcode-cn.com/problemset/…<ExternalLinkIcon/></a> 这个 URL，标识一个特定资源并表示该资源的某种形式是可以通过 HTTP 协议从相应位置获得。</p>
...
<h3 id="_23-为什么-fidder-charles-能抓到你的包【抓取数据包的过程】" tabindex="-1"><a class="header-anchor" href="#_23-为什么-fidder-charles-能抓到你的包【抓取数据包的过程】" aria-hidden="true">#</a> 23. 为什么 fidder，charles 能抓到你的包【抓取数据包的过程】</h3>
...
<h3 id="_24-如果你访问一个网站很慢-怎么排查和解决" tabindex="-1"><a class="header-anchor" href="#_24-如果你访问一个网站很慢-怎么排查和解决" aria-hidden="true">#</a> 24. 如果你访问一个网站很慢，怎么排查和解决</h3>
...
<h3 id="_25-其他协议" tabindex="-1"><a class="header-anchor" href="#_25-其他协议" aria-hidden="true">#</a> 25. 其他协议</h3>
...
<h3 id="_26-网页解析全过程【用户输入网址到显示对应页面的全过程】" tabindex="-1"><a class="header-anchor" href="#_26-网页解析全过程【用户输入网址到显示对应页面的全过程】" aria-hidden="true">#</a> 26. 网页解析全过程【用户输入网址到显示对应页面的全过程】</h3>
<p><img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dadeadd36a41416bb7f89026d68b6a77~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"> ① DNS 解析：当用户输入一个网址并按下回车键的时候，浏览器获得一个域名，而在实际通信过程中，我们需要的是一个 IP 地址，因此我们需要先把域名转换成相应 IP 地址。【具体细节参看问题 16，17】</p>
...
<h2 id="三-传输层" tabindex="-1"><a class="header-anchor" href="#三-传输层" aria-hidden="true">#</a> 三：传输层</h2>
<h3 id="_1-三次握手和四次挥手机制" tabindex="-1"><a class="header-anchor" href="#_1-三次握手和四次挥手机制" aria-hidden="true">#</a> 1. 三次握手和四次挥手机制</h3>
<p><strong>三次握手</strong> <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e43a8e15606d4ff7b5cc4c41361d5d1d~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"> 三次握手是 TCP 连接的建立过程。在握手之前，主动打开连接的客户端结束 CLOSE 阶段，被动打开的服务器也结束 CLOSE 阶段，并进入 LISTEN 阶段。随后进入三次握手阶段：</p>
...
<p><strong>四次挥手：</strong> <img src="https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8d9f6dd8c3c14e4fb2f3c6f303df5e8e~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"> 四次挥手即 TCP 连接的释放，这里假设客户端主动释放连接。在挥手之前主动释放连接的客户端结束 ESTABLISHED 阶段，随后开始四次挥手：</p>
...
<h3 id="_2-如果三次握手的时候每次握手信息对方没有收到会怎么样" tabindex="-1"><a class="header-anchor" href="#_2-如果三次握手的时候每次握手信息对方没有收到会怎么样" aria-hidden="true">#</a> 2. 如果三次握手的时候每次握手信息对方没有收到会怎么样</h3>
<ul>
...
<h3 id="_3-为什么要进行三次握手-两次握手可以吗" tabindex="-1"><a class="header-anchor" href="#_3-为什么要进行三次握手-两次握手可以吗" aria-hidden="true">#</a> 3. 为什么要进行三次握手？两次握手可以吗？</h3>
...
<h3 id="_4-第-2-次握手传回了-ack-为什么还要传回-syn" tabindex="-1"><a class="header-anchor" href="#_4-第-2-次握手传回了-ack-为什么还要传回-syn" aria-hidden="true">#</a> 4. 第 2 次握手传回了 ACK，为什么还要传回 SYN</h3>
<p>ACK 是为了告诉客户端发来的数据已经接收无误，而传回 SYN 是为了告诉客户端，服务端收到的消息确实是客户端发送的消息。</p>
<h3 id="_5-为什么要四次挥手" tabindex="-1"><a class="header-anchor" href="#_5-为什么要四次挥手" aria-hidden="true">#</a> 5. 为什么要四次挥手？</h3>
...
<h3 id="_6-close-wait-和-time-wait-的状态和意义" tabindex="-1"><a class="header-anchor" href="#_6-close-wait-和-time-wait-的状态和意义" aria-hidden="true">#</a> 6. CLOSE-WAIT 和 TIME-WAIT 的状态和意义</h3>
<p>在服务器收到客户端关闭连接的请求并告诉客户端自己已经成功收到了该请求之后，服务器进入了 CLOSE-WAIT 状态，然而此时有可能服务端还有一些数据没有传输完成，因此不能立即关闭连接，而 CLOSE-WAIT 状态就是为了保证服务器在关闭连接之前将待发送的数据发送完成。</p>
...
<h3 id="_7-time-wait-状态会导致什么问题-怎么解决" tabindex="-1"><a class="header-anchor" href="#_7-time-wait-状态会导致什么问题-怎么解决" aria-hidden="true">#</a> 7. TIME_WAIT 状态会导致什么问题，怎么解决</h3>
...
<h3 id="_8-time-wait-为什么是-2msl" tabindex="-1"><a class="header-anchor" href="#_8-time-wait-为什么是-2msl" aria-hidden="true">#</a> 8. TIME-WAIT 为什么是 2MSL</h3>
...
<h3 id="_9-有很多-time-wait-状态如何解决" tabindex="-1"><a class="header-anchor" href="#_9-有很多-time-wait-状态如何解决" aria-hidden="true">#</a> 9. 有很多 TIME-WAIT 状态如何解决</h3>
...
<h3 id="_10-有很多-close-wait-怎么解决" tabindex="-1"><a class="header-anchor" href="#_10-有很多-close-wait-怎么解决" aria-hidden="true">#</a> 10. 有很多 CLOSE-WAIT 怎么解决</h3>
<ul>
...
<h3 id="_11-tcp-和-udp-的区别" tabindex="-1"><a class="header-anchor" href="#_11-tcp-和-udp-的区别" aria-hidden="true">#</a> 11. TCP 和 UDP 的区别</h3>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5e26ed2859b241b3be1eb930ec32f356~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<h3 id="_12-tcp-协议中的定时器" tabindex="-1"><a class="header-anchor" href="#_12-tcp-协议中的定时器" aria-hidden="true">#</a> 12. TCP 协议中的定时器</h3>
<p>TCP中有七种计时器，分别为：</p>
<ul>
...
<h3 id="_13-tcp-是如何保证可靠性的" tabindex="-1"><a class="header-anchor" href="#_13-tcp-是如何保证可靠性的" aria-hidden="true">#</a> 13. TCP 是如何保证可靠性的</h3>
<p><strong>数据分块</strong>： 应用数据被分割成 TCP 认为最适合发送的数据块。</p>
...
<h3 id="_14-udp-为什么是不可靠的-bind-和-connect-对于-udp-的作用是什么" tabindex="-1"><a class="header-anchor" href="#_14-udp-为什么是不可靠的-bind-和-connect-对于-udp-的作用是什么" aria-hidden="true">#</a> 14. UDP 为什么是不可靠的？bind 和 connect 对于 UDP 的作用是什么</h3>
...
<h3 id="_15-tcp-超时重传的原理" tabindex="-1"><a class="header-anchor" href="#_15-tcp-超时重传的原理" aria-hidden="true">#</a> 15. TCP 超时重传的原理</h3>
...
<h3 id="_16-tcp-的停止等待协议是什么" tabindex="-1"><a class="header-anchor" href="#_16-tcp-的停止等待协议是什么" aria-hidden="true">#</a> 16. TCP 的停止等待协议是什么</h3>
<p>停止等待协议是为了实现 TCP 可靠传输而提出的一种相对简单的协议，该协议指的是发送方每发完一组数据后，直到收到接收方的确认信号才继续发送下一组数据。我们通过四种情形来帮助理解停等协议是如何实现可靠传输的：</p>
<p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/eb64698e5881443d9455c76bf01597e0~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<p>① 无差错传输</p>
...
<p><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/99b8534c772647f3b0fc7c41272e72f3~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<p>③ 确认丢失</p>
...
<h3 id="_17-tcp-最大连接数限制" tabindex="-1"><a class="header-anchor" href="#_17-tcp-最大连接数限制" aria-hidden="true">#</a> 17. TCP 最大连接数限制</h3>
<ul>
...
<h3 id="_18-tcp-流量控制与拥塞控制" tabindex="-1"><a class="header-anchor" href="#_18-tcp-流量控制与拥塞控制" aria-hidden="true">#</a> 18. TCP 流量控制与拥塞控制</h3>
<ul>
<li>流量控制</li>
</ul>
...
<h3 id="_19-如果接收方滑动窗口满了-发送方会怎么做" tabindex="-1"><a class="header-anchor" href="#_19-如果接收方滑动窗口满了-发送方会怎么做" aria-hidden="true">#</a> 19. 如果接收方滑动窗口满了，发送方会怎么做</h3>
<p>基于 TCP 流量控制中的滑动窗口协议，我们知道接收方返回给发送方的 ACK 包中会包含自己的接收窗口大小，若接收窗口已满，此时接收方返回给发送方的接收窗口大小为 0，此时发送方会等待接收方发送的窗口大小直到变为非 0 为止，然而，接收方回应的 ACK 包是存在丢失的可能的，为了防止双方一直等待而出现死锁情况，此时就需要坚持计时器来辅助发送方周期性地向接收方查询，以便发现窗口是否变大【坚持计时器参考问题】，当发现窗口大小变为非零时，发送方便继续发送数据。</p>
<h3 id="_20-tcp-拥塞控制采用的四种算法" tabindex="-1"><a class="header-anchor" href="#_20-tcp-拥塞控制采用的四种算法" aria-hidden="true">#</a> 20. TCP 拥塞控制采用的四种算法</h3>
<ul>
<li>慢开始</li>
</ul>
...
<h3 id="_21-tcp-粘包问题" tabindex="-1"><a class="header-anchor" href="#_21-tcp-粘包问题" aria-hidden="true">#</a> 21. TCP 粘包问题</h3>
...
<h3 id="_22-tcp-报文包含哪些信息" tabindex="-1"><a class="header-anchor" href="#_22-tcp-报文包含哪些信息" aria-hidden="true">#</a> 22. TCP 报文包含哪些信息</h3>
<p>TCP 报文是 TCP 传输的的数据单元，也叫做报文段，其报文格式如下图所示：</p>
<p><img src="https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/36ad4ec349134a269d47a4236eb5c456~tplv-k3u1fbpfcp-watermark.awebp" alt="img" loading="lazy"></p>
<ul>
...
<h3 id="_23-syn-flood-是什么" tabindex="-1"><a class="header-anchor" href="#_23-syn-flood-是什么" aria-hidden="true">#</a> 23. SYN FLOOD 是什么</h3>
...
<h3 id="_24-为什么服务端易受到-syn-攻击" tabindex="-1"><a class="header-anchor" href="#_24-为什么服务端易受到-syn-攻击" aria-hidden="true">#</a> 24. 为什么服务端易受到 SYN 攻击</h3>
...
<h3 id="_25-高并发服务器客户端主动关闭连接和服务端主动关闭连接的区别" tabindex="-1"><a class="header-anchor" href="#_25-高并发服务器客户端主动关闭连接和服务端主动关闭连接的区别" aria-hidden="true">#</a> 25. 高并发服务器客户端主动关闭连接和服务端主动关闭连接的区别</h3>
<p>以下是针对 TCP 服务来说的：</p>
<ul>
<li>服务端主动关闭连接</li>
</ul>
...
<h2 id="四-网络层" tabindex="-1"><a class="header-anchor" href="#四-网络层" aria-hidden="true">#</a> 四：网络层</h2>
<h3 id="_1-ip-协议的定义和作用" tabindex="-1"><a class="header-anchor" href="#_1-ip-协议的定义和作用" aria-hidden="true">#</a> 1. IP 协议的定义和作用</h3>
<p>IP 协议（Internet Protocol）又称互联网协议，是支持网间互联的数据包协议。该协议工作在网络层，主要目的就是为了提高网络的可扩展性，和传输层 TCP 相比，IP 协议提供一种无连接/不可靠、尽力而为的数据包传输服务，其与TCP协议（传输控制协议）一起构成了TCP/IP 协议族的核心。IP 协议主要有以下几个作用：</p>
<ul>
...
<h3 id="_2-域名和-ip-的关系-一个-ip-可以对应多个域名吗" tabindex="-1"><a class="header-anchor" href="#_2-域名和-ip-的关系-一个-ip-可以对应多个域名吗" aria-hidden="true">#</a> 2. 域名和 IP 的关系，一个 IP 可以对应多个域名吗</h3>
<p>IP 在同一个网络中是唯一的，用来标识每一个网络上的设备，其相当于一个人的身份证号；域名在同一个网络中也是唯一的，就像一个人的名字，绰号。假如你有多个不同的绰号，你的朋友可以用其中任何一个绰号叫你，但你的身份证号码却是唯一的。由此我们可以看出一个域名只能对应一个 IP 地址，是一对一的关系；而一个 IP 却可以对应多个域名，是一对多的关系。</p>
<h3 id="_3-ipv4-地址不够如何解决" tabindex="-1"><a class="header-anchor" href="#_3-ipv4-地址不够如何解决" aria-hidden="true">#</a> 3. IPV4 地址不够如何解决</h3>
<ul>
...
<h3 id="_4-路由器的分组转发流程" tabindex="-1"><a class="header-anchor" href="#_4-路由器的分组转发流程" aria-hidden="true">#</a> 4. 路由器的分组转发流程</h3>
...
<p>⑥ 无法找到合适路由，向源主机报错。</p>
<h3 id="_5-路由器和交换机的区别" tabindex="-1"><a class="header-anchor" href="#_5-路由器和交换机的区别" aria-hidden="true">#</a> 5. 路由器和交换机的区别</h3>
<ul>
...
<h3 id="_6-icmp-协议概念-作用" tabindex="-1"><a class="header-anchor" href="#_6-icmp-协议概念-作用" aria-hidden="true">#</a> 6. ICMP 协议概念/作用</h3>
...
<h3 id="_7-icmp-的应用" tabindex="-1"><a class="header-anchor" href="#_7-icmp-的应用" aria-hidden="true">#</a> 7. ICMP 的应用</h3>
<ul>
<li>Ping</li>
</ul>
...
<h3 id="_8-两台电脑连起来后-ping-不通-你觉得可能存在哪些问题" tabindex="-1"><a class="header-anchor" href="#_8-两台电脑连起来后-ping-不通-你觉得可能存在哪些问题" aria-hidden="true">#</a> 8. 两台电脑连起来后 ping 不通，你觉得可能存在哪些问题？</h3>
<ol>
...
<h3 id="_9-arp-地址解析协议的原理和地址解析过程" tabindex="-1"><a class="header-anchor" href="#_9-arp-地址解析协议的原理和地址解析过程" aria-hidden="true">#</a> 9. ARP 地址解析协议的原理和地址解析过程</h3>
<p>ARP（Address Resolution Protocol）是地址解析协议的缩写，该协议提供根据 IP 地址获取物理地址的功能，它工作在第二层，是一个数据链路层协议，其在本层和物理层进行联系，同时向上层提供服务。当通过以太网发送 IP 数据包时，需要先封装 32 位的 IP 地址和 48位 MAC 地址。在局域网中两台主机进行通信时需要依靠各自的物理地址进行标识，但由于发送方只知道目标 IP 地址，不知道其 MAC 地址，因此需要使用地址解析协议。 ARP 协议的解析过程如下：</p>
...
<h3 id="_10-网络地址转换-nat" tabindex="-1"><a class="header-anchor" href="#_10-网络地址转换-nat" aria-hidden="true">#</a> 10. 网络地址转换 NAT</h3>
...
<h3 id="_11-ttl-是什么-有什么作用" tabindex="-1"><a class="header-anchor" href="#_11-ttl-是什么-有什么作用" aria-hidden="true">#</a> 11. TTL 是什么？有什么作用</h3>
...
<h3 id="_12-运输层协议和网络层协议的区别" tabindex="-1"><a class="header-anchor" href="#_12-运输层协议和网络层协议的区别" aria-hidden="true">#</a> 12. 运输层协议和网络层协议的区别</h3>
<p>网络层协议负责提供主机间的逻辑通信；运输层协议负责提供进程间的逻辑通信。</p>
<h2 id="五-数据链路层" tabindex="-1"><a class="header-anchor" href="#五-数据链路层" aria-hidden="true">#</a> 五：数据链路层</h2>
<h3 id="_1-mac-地址和-ip-地址分别有什么作用" tabindex="-1"><a class="header-anchor" href="#_1-mac-地址和-ip-地址分别有什么作用" aria-hidden="true">#</a> 1. MAC 地址和 IP 地址分别有什么作用</h3>
<ul>
<li>MAC 地址是数据链路层和物理层使用的地址，是写在网卡上的物理地址。MAC 地址用来定义网络设备的位置。</li>
<li>IP 地址是网络层和以上各层使用的地址，是一种逻辑地址。IP 地址用来区别网络上的计算机。</li>
</ul>
<h3 id="_2-为什么有了-mac-地址还需要-ip-地址" tabindex="-1"><a class="header-anchor" href="#_2-为什么有了-mac-地址还需要-ip-地址" aria-hidden="true">#</a> 2. 为什么有了 MAC 地址还需要 IP 地址</h3>
...
<h3 id="_3-为什么有了-ip-地址还需要-mac-地址" tabindex="-1"><a class="header-anchor" href="#_3-为什么有了-ip-地址还需要-mac-地址" aria-hidden="true">#</a> 3. 为什么有了 IP 地址还需要 MAC 地址</h3>
<p>只有当设备连入网络时，才能根据他进入了哪个子网来为其分配 IP 地址，在设备还没有 IP 地址的时候或者在分配 IP 地址的过程中，我们需要 MAC 地址来区分不同的设备。</p>
<h3 id="_4-私网地址和公网地址之间进行转换-同一个局域网内的两个私网地址-经过转换之后外面看到的一样吗" tabindex="-1"><a class="header-anchor" href="#_4-私网地址和公网地址之间进行转换-同一个局域网内的两个私网地址-经过转换之后外面看到的一样吗" aria-hidden="true">#</a> 4. 私网地址和公网地址之间进行转换：同一个局域网内的两个私网地址，经过转换之后外面看到的一样吗</h3>
<p>当采用静态或者动态转换时，由于一个私网 IP 地址对应一个公网地址，因此经过转换之后的公网 IP 地址是不同的；而采用端口复用方式的话，在一个子网中的所有地址都采用一个公网地址，但是使用的端口是不同的。</p>
<h3 id="_5-以太网中的-csma-cd-协议" tabindex="-1"><a class="header-anchor" href="#_5-以太网中的-csma-cd-协议" aria-hidden="true">#</a> 5. 以太网中的 CSMA/CD 协议</h3>
...
<h3 id="_6-数据链路层上的三个基本问题" tabindex="-1"><a class="header-anchor" href="#_6-数据链路层上的三个基本问题" aria-hidden="true">#</a> 6. 数据链路层上的三个基本问题</h3>
<p><strong>封装成帧</strong>：将网络层传下来的分组前后分别添加首部和尾部，这样就构成了帧。首部和尾部的一个重要作用是帧定界，也携带了一些必要的控制信息，对于每种数据链路层协议都规定了帧的数据部分的最大长度。</p>
...
<h3 id="_7-ppp-协议" tabindex="-1"><a class="header-anchor" href="#_7-ppp-协议" aria-hidden="true">#</a> 7. PPP 协议</h3>
...
<h3 id="_8-为什么-ppp-协议不使用序号和确认机制" tabindex="-1"><a class="header-anchor" href="#_8-为什么-ppp-协议不使用序号和确认机制" aria-hidden="true">#</a> 8. 为什么 PPP 协议不使用序号和确认机制</h3>
<ul>
...
<h3 id="_9-物理层主要做什么事情" tabindex="-1"><a class="header-anchor" href="#_9-物理层主要做什么事情" aria-hidden="true">#</a> 9. 物理层主要做什么事情</h3>
...
<h3 id="_10-主机之间的通信方式" tabindex="-1"><a class="header-anchor" href="#_10-主机之间的通信方式" aria-hidden="true">#</a> 10. 主机之间的通信方式</h3>
<p><strong>单工通信</strong>：也叫单向通信，发送方和接收方是固定的，消息只能单向传输。例如采集气象数据、家庭电费，网费等数据收集系统，或者打印机等应用主要采用单工通信。 <strong>半双工通信</strong>：也叫双向交替通信，通信双方都可以发送消息，但同一时刻同一信道只允许单方向发送数据。例如传统的对讲机使用的就是半双工通信。 <strong>全双工通信</strong>：也叫双向同时通信，全双工通信允许通信双方同时在两个方向是传输，其要求通信双方都具有独立的发送和接收数据的能力。例如平时我们打电话，自己说话的同时也能听到对面的声音。</p>
<h3 id="_11-通道复用技术" tabindex="-1"><a class="header-anchor" href="#_11-通道复用技术" aria-hidden="true">#</a> 11. 通道复用技术</h3>
<p><strong>频分复用（FDM，Frequency Division Multiplexing）</strong> 频分复用将传输信道的总带宽按频率划分为若干个子频带或子信道，每个子信道传输一路信号。用户分到一定的频带后，在数据传输的过程中自始至终地占用这个频带。由于每个用户所分到的频带不同，使得传输信道在同一时刻能够支持不同用户进行数据传输，从而实现复用。除了传统意义上的 FDM 外，目前正交频分复用（OFDM）已在高速通信系统中得到广泛应用。</p>
...
<h3 id="_12-几种常用的宽带接入技术" tabindex="-1"><a class="header-anchor" href="#_12-几种常用的宽带接入技术" aria-hidden="true">#</a> 12. 几种常用的宽带接入技术</h3>
...
<h2 id="六-物理层" tabindex="-1"><a class="header-anchor" href="#六-物理层" aria-hidden="true">#</a> 六：物理层</h2>
<h3 id="_1-物理层主要做什么事情" tabindex="-1"><a class="header-anchor" href="#_1-物理层主要做什么事情" aria-hidden="true">#</a> 1. 物理层主要做什么事情</h3>
<p>作为 OSI 参考模型最低的一层，物理层是整个开放系统的基础，该层利用传输介质为通信的两端建立、管理和释放物理连接，实现比特流的透明传输。物理层考虑的是怎样才能在连接各种计算机的传输媒体上传输数据比特流，其尽可能地屏蔽掉不同种类传输媒体和通信手段的差异，使物理层上面的数据链路层感觉不到这些差异，这样就可以使数据链路层只考虑完成本层的协议和服务，而不必考虑网络的具体传输媒体和通信手段是什么。</p>
<h3 id="_2-主机之间的通信方式" tabindex="-1"><a class="header-anchor" href="#_2-主机之间的通信方式" aria-hidden="true">#</a> 2. 主机之间的通信方式</h3>
<p><strong>单工通信</strong>：也叫单向通信，发送方和接收方是固定的，消息只能单向传输。例如采集气象数据、家庭电费，网费等数据收集系统，或者打印机等应用主要采用单工通信。 <strong>半双工通信</strong>：也叫双向交替通信，通信双方都可以发送消息，但同一时刻同一信道只允许单方向发送数据。例如传统的对讲机使用的就是半双工通信。 <strong>全双工通信</strong>：也叫双向同时通信，全双工通信允许通信双方同时在两个方向是传输，其要求通信双方都具有独立的发送和接收数据的能力。例如平时我们打电话，自己说话的同时也能听到对面的声音。</p>
<h3 id="_3-通道复用技术" tabindex="-1"><a class="header-anchor" href="#_3-通道复用技术" aria-hidden="true">#</a> 3. 通道复用技术</h3>
<p><strong>频分复用（FDM，Frequency Division Multiplexing）</strong> 频分复用将传输信道的总带宽按频率划分为若干个子频带或子信道，每个子信道传输一路信号。用户分到一定的频带后，在数据传输的过程中自始至终地占用这个频带。由于每个用户所分到的频带不同，使得传输信道在同一时刻能够支持不同用户进行数据传输，从而实现复用。除了传统意义上的 FDM 外，目前正交频分复用（OFDM）已在高速通信系统中得到广泛应用。</p>
<p><strong>时分复用（TDM，Time Division Multiplexing）</strong> 顾名思义，时分复用将信道传输信息的时间划分为若干个时间片，每一个时分复用的用户在每一个 TDM 帧中占用固定时隙进行数据传输。用户所分配到的时隙是固定的，所以时分复用有时也叫做同步时分复用。这种分配方式能够便于调节控制，但是也存在缺点，当某个信道空闲时，其他繁忙的信道无法占用该空闲信道，因此会降低信道利用率。</p>
<p><strong>波分复用（WDM，Wavelength Division Multiplexing）</strong> 在光通信领域通常按照波长而不是频率来命名，因为光的频率和波长具有单一对应关系，因此 WDM 本质上也是 FDM，光通信系统中，通常由光来运载信号进行传输，WDM 是在一条光纤上传输多个波长光信号，其将 1 根光纤看做多条「虚拟」光纤，每条「虚拟」光纤工作在不同的波长上，从而极大地提高了光纤的传输容量。</p>
<p><strong>码分复用（CDM，Code Division Multiplexing）</strong> 码分复用是靠不同的编码来区分各路原始信号的一种复用方式，不同的用户使用相互正交的码字携带信息。由于码组相互正交，因此接收方能够有效区分不同的用户数据，从而实现每一个用户可以在同样的时间在同样的频带进行数据传输，频谱资源利用率高。其主要和各种多址接入技术相结合从而产生各种接入技术，包括无线和优先接入。</p>
<h3 id="_4-几种常用的宽带接入技术" tabindex="-1"><a class="header-anchor" href="#_4-几种常用的宽带接入技术" aria-hidden="true">#</a> 4. 几种常用的宽带接入技术</h3>
<p>我们一般将速率超过 1 Mbps 的接入称为宽带接入，目前常用的宽带接入技术主要包括：ADSL 和 FTTx + LAN。</p>
<ul>
<li>ADSL</li>
</ul>
...
<p>其中 FTTx 英文翻译为 Fiber To The X，这里的 X 指任何地方，我们可以理解为光纤可以接入到任何地方，而 LAN 指的是局域网。FTTx + LAN 是一种在接入网全部或部分采用光纤传输介质，构成光纤用户线路，从而实现用户高速上网的接入技术，其中用户速率可达 20 Mbps。这种接入技术投资规模小，网络拓展性强，网络可靠稳定，使得其应用广泛，目前是城市汇总较为普及的一种宽带接入技术。</p>
<p>其它还有 光纤同轴混合网（HFC）、光接入技术（有源和无源光纤系统）和无线接入技术等等。</p>
<h2 id="七-计算机网络中的安全问题" tabindex="-1"><a class="header-anchor" href="#七-计算机网络中的安全问题" aria-hidden="true">#</a> 七：计算机网络中的安全问题</h2>
<h3 id="_1-安全攻击有哪些" tabindex="-1"><a class="header-anchor" href="#_1-安全攻击有哪些" aria-hidden="true">#</a> 1. 安全攻击有哪些</h3>
...
<h3 id="_2-arp-攻击" tabindex="-1"><a class="header-anchor" href="#_2-arp-攻击" aria-hidden="true">#</a> 2. ARP 攻击</h3>
...
<h3 id="_3-对称加密和非对称的区别-非对称加密有哪些" tabindex="-1"><a class="header-anchor" href="#_3-对称加密和非对称的区别-非对称加密有哪些" aria-hidden="true">#</a> 3. 对称加密和非对称的区别，非对称加密有哪些</h3>
<ul>
...
<h3 id="_4-aes-的过程" tabindex="-1"><a class="header-anchor" href="#_4-aes-的过程" aria-hidden="true">#</a> 4. AES 的过程</h3>
...
<h3 id="_5-rsa-和-aes-算法有什么区别" tabindex="-1"><a class="header-anchor" href="#_5-rsa-和-aes-算法有什么区别" aria-hidden="true">#</a> 5. RSA 和 AES 算法有什么区别</h3>
<ul>
<li>RSA</li>
</ul>
...
<h3 id="_6-ddos-有哪些-如何防范" tabindex="-1"><a class="header-anchor" href="#_6-ddos-有哪些-如何防范" aria-hidden="true">#</a> 6. DDoS 有哪些，如何防范</h3>
