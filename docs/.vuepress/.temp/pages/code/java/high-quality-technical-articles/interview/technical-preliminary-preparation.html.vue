...
<p><strong>原文地址：</strong> <a href="https://www.cnblogs.com/lovesqcc/p/15169365.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/lovesqcc/p/15169365.html<ExternalLinkIcon/></a></p>
</blockquote>
<h2 id="考察目标和思路" tabindex="-1"><a class="header-anchor" href="#考察目标和思路" aria-hidden="true">#</a> 考察目标和思路</h2>
<p>首先明确，技术初试的考察目标：</p>
<ul>
<li>候选人的技术基础；</li>
<li>候选人解决问题的思路和能力。</li>
...
<h2 id="技术基础考察" tabindex="-1"><a class="header-anchor" href="#技术基础考察" aria-hidden="true">#</a> 技术基础考察</h2>
<h3 id="为什么要考察技术基础" tabindex="-1"><a class="header-anchor" href="#为什么要考察技术基础" aria-hidden="true">#</a> 为什么要考察技术基础?</h3>
...
<h3 id="技术基础怎么考察" tabindex="-1"><a class="header-anchor" href="#技术基础怎么考察" aria-hidden="true">#</a> 技术基础怎么考察？</h3>
<p>技术基础怎么考察？通过有效的多角度的发问模式来考察。</p>
<h4 id="是什么-为什么" tabindex="-1"><a class="header-anchor" href="#是什么-为什么" aria-hidden="true">#</a> 是什么-为什么</h4>
<p>是什么考察对概念的基本理解，为什么考察对概念的实现原理。</p>
<p>比如：索引是什么？ 索引是如何实现的？</p>
<h4 id="引导-横向发问-深入发问" tabindex="-1"><a class="header-anchor" href="#引导-横向发问-深入发问" aria-hidden="true">#</a> 引导-横向发问-深入发问</h4>
<p>引导性，比如 “你对 Java 同步工具熟悉吗？” 作个试探，得到肯定答复后，可以进一步问： “你熟悉哪些同步工具类？” 了解候选者的广度；</p>
<p>获取候选者的回答后，可以进一步问：“ 谈谈 <code v-pre>ConcurrentHashMap</code> 或 <code v-pre>AQS</code> 的实现原理？”</p>
<p>一个人在多大程度上把技术原理能讲得清晰，包括思路和细节，说明他对技术的掌握能力有多强。</p>
<h4 id="跳跃式-交叉式发问" tabindex="-1"><a class="header-anchor" href="#跳跃式-交叉式发问" aria-hidden="true">#</a> 跳跃式/交叉式发问</h4>
<p>比如：讲到哈希高效查找，可以谈谈哈希一致性算法 。 两者既有关联又有很多不同点。也是一种技术广度的考察方法。</p>
<h4 id="总结性发问" tabindex="-1"><a class="header-anchor" href="#总结性发问" aria-hidden="true">#</a> 总结性发问</h4>
<p>比如：你在做 XXX 中，获得了哪些可以分享的经验？ 考察候选人的归纳总结能力。</p>
<h4 id="实战与理论结合" tabindex="-1"><a class="header-anchor" href="#实战与理论结合" aria-hidden="true">#</a> 实战与理论结合</h4>
...
<h4 id="熟悉与不熟悉结合" tabindex="-1"><a class="header-anchor" href="#熟悉与不熟悉结合" aria-hidden="true">#</a> 熟悉与不熟悉结合</h4>
<p>针对候选人简历上写的熟悉的部分，和没有写出的都问下。比如候选人简历上写着：熟悉 JVM 内存模型， 那我就考察下内存管理相关（熟悉部分），再考察下 Java 并发工具类（不确定是否熟悉部分）。</p>
<h4 id="死知识与活知识结合" tabindex="-1"><a class="header-anchor" href="#死知识与活知识结合" aria-hidden="true">#</a> 死知识与活知识结合</h4>
<p>比如，查找算法有哪些？顺序查找、二分查找、哈希查找。这些大家通常能说出来，也是“死知识”。</p>
<p>这些查找算法各适用于什么场景？在你工作中，有哪些场景用到了哪些查找算法？为什么？ 这些是“活知识”。</p>
<h4 id="学习或工作中遇到的" tabindex="-1"><a class="header-anchor" href="#学习或工作中遇到的" aria-hidden="true">#</a> 学习或工作中遇到的</h4>
<p>有时，在学习和工作中遇到的问题，也可以作为面试题。</p>
<p>比如，最近在学习《操作系统导论》并发部分，有一章节是如何使数据结构成为线程安全的。这里就有一些可以提问的地方：如何实现一个锁？如何实现一个线程安全的计数器？如何实现一个线程安全的链表？如何实现一个线程安全的 <code v-pre>Map</code> ？如何提升并发的性能？</p>
<p>工作中遇到的问题，也可以抽象提炼出来，作为技术基础面试题。</p>
<h4 id="技术栈适配度发问" tabindex="-1"><a class="header-anchor" href="#技术栈适配度发问" aria-hidden="true">#</a> 技术栈适配度发问</h4>
<p>如果候选人（简历上所写的）使用的某些技术与本公司的技术栈比较契合，则可以针对这些技术点进行深入提问，考察候选人在这些技术点的掌握程度。如果掌握程度比较好，则技术适配度相对更高一些。</p>
<p>当然，这一点并不能作为筛掉那些没有使用该技术栈的候选人的依据。比如本公司使用 <code v-pre>MongoDB</code> 和 <code v-pre>MySQL</code>， 而一个候选人没有用过 <code v-pre>Mongodb，</code> 但使用过 <code v-pre>MySQL</code>, <code v-pre>Redis</code>, <code v-pre>ES</code>, <code v-pre>HBase</code> 等多种存储系统，那么适配度并不比仅使用过 <code v-pre>MySQL</code> 和 <code v-pre>MongoDB</code> 的候选人逊色，因为他所涉及的技术广度更大，可以推断出他有足够能力掌握 <code v-pre>Mongodb</code>。</p>
<h4 id="创造有个性的面试题库" tabindex="-1"><a class="header-anchor" href="#创造有个性的面试题库" aria-hidden="true">#</a> 创造有个性的面试题库</h4>
<p>每个技术面试官都会有一个面试题库。持续积累面试题库，日常中突然想到的问题，就随手记录下来。</p>
<h2 id="业务维度考察" tabindex="-1"><a class="header-anchor" href="#业务维度考察" aria-hidden="true">#</a> 业务维度考察</h2>
<h3 id="为什么要考察业务维度" tabindex="-1"><a class="header-anchor" href="#为什么要考察业务维度" aria-hidden="true">#</a> 为什么要考察业务维度？</h3>
<p>技术基础考察，容易错过的地方是，候选人的非技术能力特质，比如沟通组织能力、带项目能力、抗压能力、解决实际问题的能力、团队影响力、其它性格特质等。</p>
<h3 id="为什么不能单考察业务维度" tabindex="-1"><a class="header-anchor" href="#为什么不能单考察业务维度" aria-hidden="true">#</a> 为什么不能单考察业务维度？</h3>
...
<h2 id="解决问题能力考察" tabindex="-1"><a class="header-anchor" href="#解决问题能力考察" aria-hidden="true">#</a> 解决问题能力考察</h2>
...
<h3 id="设计问题" tabindex="-1"><a class="header-anchor" href="#设计问题" aria-hidden="true">#</a> 设计问题</h3>
<ul>
<li>比如多个机器间共享大量业务对象，这些业务对象之间有些联合字段是重复的，如何去重？</li>
<li>如果瞬时有大量请求涌入，如何保证服务器的稳定性？</li>
</ul>
<h3 id="项目经历" tabindex="-1"><a class="header-anchor" href="#项目经历" aria-hidden="true">#</a> 项目经历</h3>
...
<h2 id="面试官如何做好一场面试" tabindex="-1"><a class="header-anchor" href="#面试官如何做好一场面试" aria-hidden="true">#</a> 面试官如何做好一场面试?</h2>
...
<h3 id="面试启动" tabindex="-1"><a class="header-anchor" href="#面试启动" aria-hidden="true">#</a> 面试启动</h3>
...
<h3 id="问题设计" tabindex="-1"><a class="header-anchor" href="#问题设计" aria-hidden="true">#</a> 问题设计</h3>
<p>提前阅读候选人简历，从简历中筛选出关键词，根据这些关键词进行有针对性地问题设计。</p>
<p>比如候选人简历里提到 <code v-pre>MVVM</code> ，可以问 <code v-pre>MVVM</code> 与 <code v-pre>MVC</code> 的区别； 提到了观察者模式，可以谈谈观察者模式，顺便问问他还熟悉哪些设计模式。</p>
<h3 id="宽松氛围" tabindex="-1"><a class="header-anchor" href="#宽松氛围" aria-hidden="true">#</a> 宽松氛围</h3>
...
<h3 id="学会倾听" tabindex="-1"><a class="header-anchor" href="#学会倾听" aria-hidden="true">#</a> 学会倾听</h3>
...
<h3 id="记录重点" tabindex="-1"><a class="header-anchor" href="#记录重点" aria-hidden="true">#</a> 记录重点</h3>
<p>认真客观地记录候选人的回答，尽可能避免任何主观评价，亦不作任何加工（比如自己给总结一下，总结能力也是候选人的一个特质）。</p>
<h2 id="作出判断" tabindex="-1"><a class="header-anchor" href="#作出判断" aria-hidden="true">#</a> 作出判断</h2>
...
<h2 id="给候选人的话" tabindex="-1"><a class="header-anchor" href="#给候选人的话" aria-hidden="true">#</a> 给候选人的话</h2>
<h3 id="关注技术基础" tabindex="-1"><a class="header-anchor" href="#关注技术基础" aria-hidden="true">#</a> 关注技术基础</h3>
<p>一个常见的疑惑是：开发业务系统的大多数时候，基本不涉及数据结构与算法的设计与实现，为什么要考察 <code v-pre>HashMap</code> 的实现原理？为什么要学好数据结构与算法、操作系统、网络通信这些基础课程？</p>
<p>现在我可以给出一个答案了：</p>
<ul>
...
<h3 id="不要在意某个问题回答不上来" tabindex="-1"><a class="header-anchor" href="#不要在意某个问题回答不上来" aria-hidden="true">#</a> 不要在意某个问题回答不上来</h3>
