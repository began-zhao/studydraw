...
<p><strong>原文地址</strong> ： <a href="https://my.oschina.net/hooker/blog/3014656" target="_blank" rel="noopener noreferrer">https://my.oschina.net/hooker/blog/3014656<ExternalLinkIcon/></a></p>
</blockquote>
...
<h3 id="_1-初选如何鉴别劣质简历" tabindex="-1"><a class="header-anchor" href="#_1-初选如何鉴别劣质简历" aria-hidden="true">#</a> 1.初选如何鉴别劣质简历</h3>
...
<h3 id="_2-进入面试阶段-如何甄别对方的水分" tabindex="-1"><a class="header-anchor" href="#_2-进入面试阶段-如何甄别对方的水分" aria-hidden="true">#</a> 2. 进入面试阶段，如何甄别对方的水分</h3>
...
<p>然而笔者碰到的问题是：使用 Git 两年却不知道 Github、使用 Redis 一年却不知道数据结构也不知道序列化、专业做爬虫却不懂 <code v-pre>content-type</code> 含义、使用搜索引擎技术却说不出两个分词插件、使用数据库读写分离却不知道同步延时等等。</p>
