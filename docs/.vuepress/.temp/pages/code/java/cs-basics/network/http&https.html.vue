...
<h3 id="http-协议通信过程" tabindex="-1"><a class="header-anchor" href="#http-协议通信过程" aria-hidden="true">#</a> HTTP 协议通信过程</h3>
...
<h3 id="http-协议优点" tabindex="-1"><a class="header-anchor" href="#http-协议优点" aria-hidden="true">#</a> HTTP 协议优点</h3>
<p>扩展性强、速度快、跨平台支持性好。</p>
<h2 id="https-协议" tabindex="-1"><a class="header-anchor" href="#https-协议" aria-hidden="true">#</a> HTTPS 协议</h2>
<h3 id="https-协议介绍" tabindex="-1"><a class="header-anchor" href="#https-协议介绍" aria-hidden="true">#</a> HTTPS 协议介绍</h3>
...
<h3 id="https-协议优点" tabindex="-1"><a class="header-anchor" href="#https-协议优点" aria-hidden="true">#</a> HTTPS 协议优点</h3>
<p>保密性好、信任度高。</p>
<h2 id="https-的核心—ssl-tls协议" tabindex="-1"><a class="header-anchor" href="#https-的核心—ssl-tls协议" aria-hidden="true">#</a> HTTPS 的核心—SSL/TLS协议</h2>
<p>HTTPS 之所以能达到较高的安全性要求，就是结合了 SSL/TLS 和 TCP 协议，对通信数据进行加密，解决了 HTTP 数据透明的问题。接下来重点介绍一下 SSL/TLS 的工作原理。</p>
<h3 id="ssl-和-tls-的区别" tabindex="-1"><a class="header-anchor" href="#ssl-和-tls-的区别" aria-hidden="true">#</a> SSL 和 TLS 的区别？</h3>
...
<h3 id="ssl-tls-的工作原理" tabindex="-1"><a class="header-anchor" href="#ssl-tls-的工作原理" aria-hidden="true">#</a> SSL/TLS 的工作原理</h3>
<h4 id="非对称加密" tabindex="-1"><a class="header-anchor" href="#非对称加密" aria-hidden="true">#</a> 非对称加密</h4>
...
<p><img src="@source/code/java/cs-basics/network/images/http&amp;https/public-key-cryptography.png" alt="" loading="lazy"></p>
...
<p><img src="@source/code/java/cs-basics/network/images/http&amp;https/OWF.png" alt="单向函数" loading="lazy"></p>
...
<h4 id="对称加密" tabindex="-1"><a class="header-anchor" href="#对称加密" aria-hidden="true">#</a> 对称加密</h4>
...
<p><img src="@source/code/java/cs-basics/network/images/http&amp;https/symmetric-encryption.png" alt="" loading="lazy"></p>
...
<h4 id="公钥传输的信赖性" tabindex="-1"><a class="header-anchor" href="#公钥传输的信赖性" aria-hidden="true">#</a> 公钥传输的信赖性</h4>
...
<p><img src="@source/code/java/cs-basics/network/images/http&amp;https/attack1.png" alt="" loading="lazy"></p>
...
<p><img src="@source/code/java/cs-basics/network/images/http&amp;https/digital-signature.png" alt="" loading="lazy"></p>
...
<p><img src="@source/code/java/cs-basics/network/images/http&amp;https/public-key-transmission.png" alt="" loading="lazy"></p>
<p>对于数字签名，我这里讲的比较简单，如果你没有搞清楚的话，强烈推荐你看看<a href="https://www.bilibili.com/video/BV18N411X7ty/" target="_blank" rel="noopener noreferrer">数字签名及数字证书原理<ExternalLinkIcon/></a>这个视频，这是我看过最清晰的讲解。</p>
<p><img src="https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/github/javaguide/image-20220321121814946.png" alt="" loading="lazy"></p>
