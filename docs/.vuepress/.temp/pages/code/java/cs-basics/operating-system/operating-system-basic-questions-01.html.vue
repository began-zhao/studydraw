<template><div><p>很多读者抱怨计算操作系统的知识点比较繁杂，自己也没有多少耐心去看，但是面试的时候又经常会遇到。所以，我带着我整理好的操作系统的常见问题来啦！这篇文章总结了一些我觉得比较重要的操作系统相关的问题比如<strong>进程管理</strong>、<strong>内存管理</strong>、<strong>虚拟内存</strong>等等。</p>
<p>文章形式通过大部分比较喜欢的面试官和求职者之间的对话形式展开。另外，Guide 哥 也只是在大学的时候学习过操作系统，不过基本都忘了，为了写这篇文章这段时间看了很多相关的书籍和博客。如果文中有任何需要补充和完善的地方，你都可以在 issue 中指出！</p>
...
<p><img src="https://oscimg.oschina.net/oscnet/up-cd8ac705f6f004c01e0a1312f1599430ba5.png" alt="" loading="lazy"></p>
...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-11/d38202593012b457debbcd74994c6292.png" alt="process-state" loading="lazy"></p>
...
<h3 id="_2-8-解决死锁的方法" tabindex="-1"><a class="header-anchor" href="#_2-8-解决死锁的方法" aria-hidden="true">#</a> 2.8 解决死锁的方法</h3>
...
<h4 id="死锁的预防" tabindex="-1"><a class="header-anchor" href="#死锁的预防" aria-hidden="true">#</a> 死锁的预防</h4>
...
<h4 id="死锁的避免" tabindex="-1"><a class="header-anchor" href="#死锁的避免" aria-hidden="true">#</a> 死锁的避免</h4>
...
<p>银行家算法详情可见：<a href="https://blog.csdn.net/qq_33414271/article/details/80245715" target="_blank" rel="noopener noreferrer">《一句话+一张图说清楚——银行家算法》<ExternalLinkIcon/></a> 。</p>
...
<h4 id="死锁的检测" tabindex="-1"><a class="header-anchor" href="#死锁的检测" aria-hidden="true">#</a> 死锁的检测</h4>
...
<h5 id="进程-资源分配图" tabindex="-1"><a class="header-anchor" href="#进程-资源分配图" aria-hidden="true">#</a> 进程-资源分配图</h5>
...
<p><img src="@source/code/java/cs-basics/operating-system/images/进程-资源分配图.jpg" alt="进程-资源分配图" loading="lazy"></p>
...
<h5 id="死锁检测步骤" tabindex="-1"><a class="header-anchor" href="#死锁检测步骤" aria-hidden="true">#</a> 死锁检测步骤</h5>
...
<h4 id="死锁的解除" tabindex="-1"><a class="header-anchor" href="#死锁的解除" aria-hidden="true">#</a> 死锁的解除</h4>
...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-11/2b27dac8cc647f8aac989da2d1166db2.png" alt="MMU_principle_updated" loading="lazy"></p>
...
<li><a href="https://www.jianshu.com/p/1d47ed0b46d5" target="_blank" rel="noopener noreferrer">https://www.jianshu.com/p/1d47ed0b46d5<ExternalLinkIcon/></a></li>
...
<li>王道考研操作系统知识点整理： <a href="https://wizardforcel.gitbooks.io/wangdaokaoyan-os/content/13.html" target="_blank" rel="noopener noreferrer">https://wizardforcel.gitbooks.io/wangdaokaoyan-os/content/13.html<ExternalLinkIcon/></a></li>
</ul>
</div></template>
