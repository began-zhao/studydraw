...
<p>本文来自<a href="https://github.com/kinglaw1204" target="_blank" rel="noopener noreferrer">木木匠<ExternalLinkIcon/></a>投稿。</p>
</blockquote>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>update tb_student A set A.age='19' where A.name=' 张三 ';
