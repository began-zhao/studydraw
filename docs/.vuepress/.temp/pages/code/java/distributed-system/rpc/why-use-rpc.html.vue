...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/18-12-6/32527396.jpg" alt="RPC原理时序图" loading="lazy"></p>
...
<ul>
<li><a href="https://github.com/Snailclimb/guide-rpc-framework" target="_blank" rel="noopener noreferrer">造轮子<ExternalLinkIcon/></a></li>
</ul>
...
<ul>
<li><a href="http://www.ruanyifeng.com/blog/2016/08/http.html" target="_blank" rel="noopener noreferrer">http://www.ruanyifeng.com/blog/2016/08/http.html<ExternalLinkIcon/></a> （HTTP 协议入门- 阮一峰）</li>
</ul>
<h3 id="一个常见的错误观点" tabindex="-1"><a class="header-anchor" href="#一个常见的错误观点" aria-hidden="true">#</a> 一个常见的错误观点</h3>
<p>很多文章中还会提到说 HTTP 协议相较于自定义 TCP 报文协议，增加的开销在于连接的建立与断开，但是这个观点已经被否认，下面截取自知乎中一个回答，原回答地址：<a href="https://www.zhihu.com/question/41609070/answer/191965937" target="_blank" rel="noopener noreferrer">https://www.zhihu.com/question/41609070/answer/191965937<ExternalLinkIcon/></a> 。</p>
<blockquote>
