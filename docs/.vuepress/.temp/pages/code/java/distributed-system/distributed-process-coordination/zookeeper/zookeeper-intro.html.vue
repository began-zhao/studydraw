...
<p><img src="@source/code/java/distributed-system/distributed-process-coordination/zookeeper/images/znode-structure.png" alt="ZooKeeper 数据模型" loading="lazy"></p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>zk: <span class="token number">127.0</span>.0.1:2181<span class="token punctuation">(</span>CONNECTED<span class="token punctuation">)</span> <span class="token number">6</span><span class="token punctuation">]</span> get /dubbo
...
<p><img src="@source/code/java/distributed-system/distributed-process-coordination/zookeeper/images/watche机制.png" alt="watcher机制" loading="lazy"></p>
...
<p><img src="@source/code/java/distributed-system/distributed-process-coordination/zookeeper/images/zookeeper集群.png" alt="" loading="lazy"></p>
...
<p><img src="@source/code/java/distributed-system/distributed-process-coordination/zookeeper/images/zookeeper集群中的角色.png" alt="" loading="lazy"></p>
