...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-6/进程示例图片-Windows.png" alt="进程示例图片-Windows" loading="lazy"></p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MultiThread</span> <span class="token punctuation">{</span>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>[5] Attach Listener //添加事件
...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/19-1-29/Java线程的状态.png" alt="Java 线程的状态 " loading="lazy"></p>
<p>线程在生命周期中并不是固定处于某一个状态而是随着代码的执行在不同状态之间切换。Java 线程状态变迁如下图所示（图源 <a href="https://github.com/Snailclimb/JavaGuide/issues/736" target="_blank" rel="noopener noreferrer">issue#736<ExternalLinkIcon/></a>）：</p>
<p><img src="@source/code/java/common/concurrent/images/interview-questions/java-life-cycle.png" alt="" loading="lazy"></p>
<blockquote>
...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-3/RUNNABLE-VS-RUNNING.png" alt="RUNNABLE-VS-RUNNING" loading="lazy"></p>
...
<p><img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-4/2019-4死锁1.png" alt="线程死锁示意图 " loading="lazy"></p>
