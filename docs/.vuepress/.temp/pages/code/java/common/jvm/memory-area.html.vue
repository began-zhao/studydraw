...
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/JVM运行时数据区域.png" alt="" loading="lazy"></p>
<p><strong>JDK 1.8</strong> ：</p>
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/Java运行时数据区域JDK1.8.png" alt="" loading="lazy"></p>
...
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/stack.png" alt="栈" loading="lazy"></p>
...
<p><img src="https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/github/javaguide/jvmimage-20220331175738692.png" alt="" loading="lazy"></p>
...
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/《深入理解虚拟机》第三版的第2章-虚拟机栈.png" alt="" loading="lazy"></p>
...
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/hotspot-heap-structure.png" alt="hotspot-heap-structure" loading="lazy"></p>
...
<h3 id="方法区" tabindex="-1"><a class="header-anchor" href="#方法区" aria-hidden="true">#</a> 方法区</h3>
...
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/method-area-implementation.png" alt="HotSpot 虚拟机方法区的两种实现" loading="lazy"></p>
<p><strong>为什么要将永久代 (PermGen) 替换为元空间 (MetaSpace) 呢?</strong></p>
<p>下图来自《深入理解 Java 虚拟机》第 3 版 2.2.5</p>
<p><img src="https://img-blog.csdnimg.cn/20210425134508117.png" alt="" loading="lazy"></p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 在堆中创建字符串对象”ab“</span>
...
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/method-area-jdk1.6.png" alt="" loading="lazy"></p>
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/method-area-jdk1.7.png" alt="" loading="lazy"></p>
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/method-area-jdk1.8.png" alt="" loading="lazy"></p>
...
<h3 id="直接内存" tabindex="-1"><a class="header-anchor" href="#直接内存" aria-hidden="true">#</a> 直接内存</h3>
...
<h2 id="hotspot-虚拟机对象探秘" tabindex="-1"><a class="header-anchor" href="#hotspot-虚拟机对象探秘" aria-hidden="true">#</a> HotSpot 虚拟机对象探秘</h2>
...
<h3 id="对象的内存布局" tabindex="-1"><a class="header-anchor" href="#对象的内存布局" aria-hidden="true">#</a> 对象的内存布局</h3>
...
<h3 id="对象的访问定位" tabindex="-1"><a class="header-anchor" href="#对象的访问定位" aria-hidden="true">#</a> 对象的访问定位</h3>
...
<h4 id="句柄" tabindex="-1"><a class="header-anchor" href="#句柄" aria-hidden="true">#</a> 句柄</h4>
<p>如果使用句柄的话，那么 Java 堆中将会划分出一块内存来作为句柄池，reference 中存储的就是对象的句柄地址，而句柄中包含了对象实例数据与类型数据各自的具体地址信息。</p>
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/对象的访问定位-使用句柄.png" alt="对象的访问定位-使用句柄" loading="lazy"></p>
<h4 id="直接指针" tabindex="-1"><a class="header-anchor" href="#直接指针" aria-hidden="true">#</a> 直接指针</h4>
<p>如果使用直接指针访问，那么 Java 堆对象的布局中就必须考虑如何放置访问类型数据的相关信息，而 reference 中存储的直接就是对象的地址。</p>
<p><img src="@source/code/java/common/jvm/pictures/java内存区域/对象的访问定位-直接指针.png" alt="对象的访问定位-直接指针" loading="lazy"></p>
