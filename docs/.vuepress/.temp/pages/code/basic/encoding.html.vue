...
<!-- more -->
<h2 id="字符编码" tabindex="-1"><a class="header-anchor" href="#字符编码" aria-hidden="true">#</a> 字符编码</h2>
...
<FlowChart id="flowchart-64a570d8" code="st%3D%3Esubroutine%3A%20Unicode%20%E7%BC%96%E7%A0%81%0Asave%3D%3Eoperation%3A%20%E4%BF%9D%E5%AD%98%3A%20%E8%BD%AC%E6%8D%A2%E8%87%B3%20UTF-8%0Aload%3D%3Eoperation%3A%20%E8%AF%BB%E5%8F%96%3A%20%E8%BD%AC%E6%8D%A2%E8%87%B3%20Unicode%0Afile%3D%3Esubroutine%3A%20%E6%96%87%E4%BB%B6%20UTF-8%20%E7%BC%96%E7%A0%81%0Ast2%3D%3Esubroutine%3A%20Unicode%20%E7%BC%96%E7%A0%81%0A%0Ast-%3Esave-%3Efile-%3Eload-%3Est2%0A" preset="vue"></FlowChart><p>浏览网页的时候，服务器会把动态生成的 Unicode 内容转换为 UTF-8 再传输到浏览器:</p>
<p>所以您看到很多网页的源码上会有类似 <code v-pre>&lt;meta charset=&quot;UTF-8&quot; /&gt;</code> 的信息，表示该网页正是用的 UTF-8 编码。</p>
<h2 id="ascii-码" tabindex="-1"><a class="header-anchor" href="#ascii-码" aria-hidden="true">#</a> ASCII 码</h2>
<p>美国发布的，用 1 个字节 (8 位二进制) 来表示一个字符，共可以表示 2<sup>8</sup>=256 个字符。</p>
<p>美国的国家语言是英语，只要能表示 0-9、a-z、A-Z、特殊符号。</p>
<h2 id="ansi-编码" tabindex="-1"><a class="header-anchor" href="#ansi-编码" aria-hidden="true">#</a> ANSI 编码</h2>
<p><strong>每个国家为了显示本国的语言，都对 ASCII 码进行了扩展</strong>。用 2 个字节 (16 位二进制) 来表示一个汉字，共可以表示 <span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msup><mn>2</mn><mn>16</mn></msup><mo>=</mo><mn>65536</mn></mrow><annotation encoding="application/x-tex">2^{16} = 65536</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8141em;"></span><span class="mord"><span class="mord">2</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8141em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">16</span></span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.6444em;"></span><span class="mord">65536</span></span></span></span> 个汉字。例如:</p>
<ul>
...
<h2 id="unicode-编码-统一编码" tabindex="-1"><a class="header-anchor" href="#unicode-编码-统一编码" aria-hidden="true">#</a> Unicode 编码(统一编码)</h2>
...
<h2 id="utf-8-unicode-transform-format-编码" tabindex="-1"><a class="header-anchor" href="#utf-8-unicode-transform-format-编码" aria-hidden="true">#</a> UTF-8 (Unicode Transform Format)编码</h2>
