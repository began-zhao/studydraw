...
<!-- more -->
<h2 id="小团队的具体分工" tabindex="-1"><a class="header-anchor" href="#小团队的具体分工" aria-hidden="true">#</a> 小团队的具体分工</h2>
<p>对于小团队而言，经典的划分主要还分为三个板块</p>
<h3 id="ui-设计" tabindex="-1"><a class="header-anchor" href="#ui-设计" aria-hidden="true">#</a> UI 设计</h3>
...
<h3 id="前端开发" tabindex="-1"><a class="header-anchor" href="#前端开发" aria-hidden="true">#</a> 前端开发</h3>
...
<h3 id="后端开发" tabindex="-1"><a class="header-anchor" href="#后端开发" aria-hidden="true">#</a> 后端开发</h3>
...
<h2 id="公司开发" tabindex="-1"><a class="header-anchor" href="#公司开发" aria-hidden="true">#</a> 公司开发</h2>
<div class="custom-container note"><p class="custom-container-title">注</p>
<p>如果从职位细分的话，可以分出产品、交互、设计、开发、测试、策划、运营、维护等。</p>
</div>
<h3 id="产品设计" tabindex="-1"><a class="header-anchor" href="#产品设计" aria-hidden="true">#</a> 产品设计</h3>
<p>产品设计对应产品经理，一般负责整体内容的构思，这一过程可能还包括用户和市场调研，确定要做的产品的功能、大致交互格式，也就是将成品的草稿设计出来，</p>
<h3 id="设计师" tabindex="-1"><a class="header-anchor" href="#设计师" aria-hidden="true">#</a> 设计师</h3>
...
<h3 id="运营" tabindex="-1"><a class="header-anchor" href="#运营" aria-hidden="true">#</a> 运营</h3>
