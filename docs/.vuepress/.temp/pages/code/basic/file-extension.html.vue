<template><div><h2 id="文件名" tabindex="-1"><a class="header-anchor" href="#文件名" aria-hidden="true">#</a> 文件名</h2>
...
<h2 id="文件扩展名" tabindex="-1"><a class="header-anchor" href="#文件扩展名" aria-hidden="true">#</a> 文件扩展名</h2>
...
<div class="custom-container tip"><p class="custom-container-title">误区</p>
<ol>
<li>
