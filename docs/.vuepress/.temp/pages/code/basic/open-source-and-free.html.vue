...
<!-- more -->
<h2 id="免费软件" tabindex="-1"><a class="header-anchor" href="#免费软件" aria-hidden="true">#</a> 免费软件</h2>
<p>免费软件的例子比比皆是，QQ、微信、迅雷、酷狗、360 等都是免费软件，您可以随意使用，尽情蹂躏；但是，如果您嫌弃它们复杂，自己删除了一些无用的功能，然后在网上发布了一个精简版本供大家下载，那么您就离法院的传票不远了。</p>
<h2 id="开源软件" tabindex="-1"><a class="header-anchor" href="#开源软件" aria-hidden="true">#</a> 开源软件</h2>
...
<li>
<p>Python 目前属于 <a href="http://python.org" target="_blank" rel="noopener noreferrer">python.org<ExternalLinkIcon/></a> 开源组织，它收到了 Facebook、Google、Amazon、Redhat、Microsoft 等商业公司的赞助。</p>
</li>
</ul>
<h2 id="开源软件的盈利模式" tabindex="-1"><a class="header-anchor" href="#开源软件的盈利模式" aria-hidden="true">#</a> 开源软件的盈利模式</h2>
