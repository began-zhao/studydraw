<template><div><h2 id="gayhub-github-是世界上最大的-同性交友-代码托管网站" tabindex="-1"><a class="header-anchor" href="#gayhub-github-是世界上最大的-同性交友-代码托管网站" aria-hidden="true">#</a> <s>Gayhub</s> GitHub 是世界上最大的 <s>同性交友</s> 代码托管网站</h2>
...
<h3 id="star" tabindex="-1"><a class="header-anchor" href="#star" aria-hidden="true">#</a> Star</h3>
...
<h3 id="issue" tabindex="-1"><a class="header-anchor" href="#issue" aria-hidden="true">#</a> Issue</h3>
...
<h3 id="dicussion" tabindex="-1"><a class="header-anchor" href="#dicussion" aria-hidden="true">#</a> Dicussion</h3>
...
<h3 id="review" tabindex="-1"><a class="header-anchor" href="#review" aria-hidden="true">#</a> Review</h3>
...
<p><img src="@source/code/github/assets/mainPage.png" alt="个人主页" loading="lazy"></p>
<p><a href="https://github.com" target="_blank" rel="noopener noreferrer">https://github.com<ExternalLinkIcon/></a></p>
<p>主页，在您登陆后，屏幕的左侧会展示您和您加入团队的项目，以及您的团队详情。中部会显示您关注的项目、人的动态，右侧会根据算法展示一些您可能会感兴趣的 repo。</p>
<h2 id="个人主页" tabindex="-1"><a class="header-anchor" href="#个人主页" aria-hidden="true">#</a> 个人主页</h2>
<p><img src="@source/code/github/assets/profile.png" alt="个人主页" loading="lazy"></p>
...
<p><img src="@source/code/github/assets/personalRepo.png" alt="个人仓库" loading="lazy"></p>
...
<h3 id="stars" tabindex="-1"><a class="header-anchor" href="#stars" aria-hidden="true">#</a> Stars</h3>
<p>和仓库列表完全相同，只不过展示该用户收藏的 repo。</p>
<h3 id="followers-following" tabindex="-1"><a class="header-anchor" href="#followers-following" aria-hidden="true">#</a> Followers / Following</h3>
<p>关注您的人 / 关注的人。在个人主页的左侧就有 follow 按钮，follow 一个人意味着这个人在 GitHub 的的活动会出现在 GitHub 主页的 Activity List 上。</p>
<h2 id="仓库主页" tabindex="-1"><a class="header-anchor" href="#仓库主页" aria-hidden="true">#</a> 仓库主页</h2>
<p><img src="@source/code/github/assets/repo.png" alt="仓库主页" loading="lazy"></p>
...
<p>在下方会展示代码文件以及项目说明 <a href="http://README.md" target="_blank" rel="noopener noreferrer">README.md<ExternalLinkIcon/></a> 文件。</p>
</div></template>
