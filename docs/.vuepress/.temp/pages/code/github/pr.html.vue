...
<h2 id="提交自己贡献的代码" tabindex="-1"><a class="header-anchor" href="#提交自己贡献的代码" aria-hidden="true">#</a> 提交自己贡献的代码</h2>
<p>对于代码贡献者来说，他需要用一种方法将自己贡献的代码推送到远程库上，以便发起请求，最好的办法就是 fork 原仓库。</p>
<p><img src="@source/code/github/assets/fork.png" alt="Fork 仓库" loading="lazy"></p>
<div class="custom-container info"><p class="custom-container-title">相关信息</p>
<p>相关介绍，请见 <RouterLink to="/code/github/intro.html#fork">GitHub 简介 → fork</RouterLink></p>
</div>
...
<h2 id="发送请求" tabindex="-1"><a class="header-anchor" href="#发送请求" aria-hidden="true">#</a> 发送请求</h2>
...
<p><img src="@source/code/github/assets/pull-request.png" alt="Pull request" loading="lazy"></p>
<blockquote>
...
<p><img src="@source/code/github/assets/file-changes.png" alt="文件改动" loading="lazy"></p>
<p>同时，他们也可以对贡献者的代码进行审查，对特定行或片段标注，并陈述自己的意见，同时将这个意见根据程度标注为“探讨”、“改进”或者“必须更改”，以便贡献者进行交流讨论与完善修改。</p>
<p><img src="@source/code/github/assets/pull-request-review.png" alt="代码审查" loading="lazy"></p>
<p>同时，对于一个大型库来说，仓库所有者应该可以看到贡献的代码是否通过了所有测试。</p>
<p><img src="@source/code/github/assets/pull-request-check.png" alt="测试通过情况" loading="lazy"></p>
<p>如果审查者认为没有问题，他可能就会通过这个拉取请求，拉取对应的代码到自己的仓库上。这样您就完成了对这个仓库的贡献。</p>
<h2 id="同步原仓库" tabindex="-1"><a class="header-anchor" href="#同步原仓库" aria-hidden="true">#</a> 同步原仓库</h2>
