...
<div class="custom-container info"><p class="custom-container-title">持续集成</p>
<p>关于持续集成 (CI) 的概念与介绍，详见 <RouterLink to="/code/basic/ci.html">基础 → 持续集成</RouterLink></p>
</div>
...
<h3 id="jobs" tabindex="-1"><a class="header-anchor" href="#jobs" aria-hidden="true">#</a> Jobs</h3>
