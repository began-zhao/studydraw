...
<p><img src="@source/design/navigation/assets/navbar-name.jpg" alt="iOS 与安卓的规范与命名区别" loading="lazy"></p>
...
<p><img src="@source/design/navigation/assets/ios-navbar.jpg" alt="常规导航不同标题字号的案例及视觉效果" loading="lazy"></p>
...
<p><img src="@source/design/navigation/assets/ios-navbar-big.jpg" alt="大标题不同标题字号的案例及视觉效果" loading="lazy"></p>
...
<p><img src="@source/design/navigation/assets/navbar-big-improve.jpg" alt="改进的大标题案例" loading="lazy"></p>
...
<p><img src="@source/design/navigation/assets/ios-nav-back.jpg" alt="iOS 与安卓的导航按钮区域区别" loading="lazy"></p>
<p><img src="@source/design/navigation/assets/android-nav-back.gif" alt="iOS 与安卓的导航按钮区域区别" loading="lazy"></p>
<p>这一点与 iOS 的定义有着天壤之别，iOS 非常明确地赋予了工具栏的定义，并且将导航栏和工具栏(Toolbars)彻底地分离开，典型案例就是 Safari。</p>
<p><img src="@source/design/navigation/assets/safari.jpg" alt="iOS 明确地将导航栏与工具栏分离开" loading="lazy"></p>
<p>在内容控件上 iOS 与 Material Design 也大相径庭，Material Design 不去限制您的内容控件多少，因为它提供了溢出菜单，并可以根据屏宽的变化，自适应释出和收纳溢出菜单中的控件。</p>
<p><img src="@source/design/navigation/assets/android-size-adjust.gif" alt="安卓动态调整" loading="lazy"></p>
<p>而 iOS 则规定我们，要给内容控件按钮足够多的空间，必要的时候，隐藏导航栏标题也未尝不可。</p>
<p><img src="@source/design/navigation/assets/ios-nav-space.jpg" alt="iOS 导航栏空间" loading="lazy"></p>
...
<p><img src="@source/design/navigation/assets/ios-callout.jpg" alt="Material Design的溢出菜单也被运用在iOS端" loading="lazy"></p>
...
<p><img src="@source/design/navigation/assets/android-shadow.gif" alt="区分导航栏与内容区域的层级关系" loading="lazy"></p>
<p><img src="@source/design/navigation/assets/ios-divide.jpg" alt="区分导航栏与内容区域的层级关系" loading="lazy"></p>
...
<p><img src="@source/design/navigation/assets/nav-control.jpg" alt="导航栏通常会承载的其他控件" loading="lazy"></p>
