...
<!-- more -->
<p><img src="@source/design/icon/assets/type.jpg" alt="三种主要类型的图标" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/meaning.jpg" alt="寓意明确的图标" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/without-text.jpg" alt="无文字信息" loading="lazy"></p>
<p>那么，再把文字信息补充进去，是不是就会觉得图形挺贴合内容的?</p>
<p><img src="@source/design/icon/assets/with-text.jpg" alt="有文字信息" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/to-goods.jpg" alt="实体化扩展" loading="lazy"></p>
<p>之后可以挑选出某个合适的实物，以它作为原型开始绘制。如果对挑选出来的实物要以什么图形表现还没概念，那么就可以借助网上的图标素材网站，比如 iconfont、iconfinder 等，在搜索框中输入这些词语，通过别人的设计获取灵感。</p>
<p><img src="@source/design/icon/assets/iconfont.jpg" alt="Iconfont" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/unconst.jpg" alt="不一致的图标" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/same-type.jpg" alt="类型一致" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/add-gap.jpg" alt="添加缺口" loading="lazy"></p>
<p>第二，在设计一套偏圆润可爱的设计风格中，外轮廓使用了较大的圆角，那么应当尽可能保证圆角的大小是一致的，而不是有的用 4pt，有的用 2pt 或者直接使用直角。</p>
<p><img src="@source/design/icon/assets/make-round.jpg" alt="使用圆角" loading="lazy"></p>
<p>第三，采用了填充色偏移的设计风格，首先要保证填充色一致，并且偏移的距离和方向也要保持固定的规律，不能随喜好任意制定。</p>
<p><img src="@source/design/icon/assets/fill-color.jpg" alt="填充色" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/3D.jpg" alt="立体感" loading="lazy"></p>
<p>透视的表现不是绘制图标时必须使用的风格，但是如果在图标中应用了透视，就要确保使用的视角是一致的。要极力避免同一套图标中既用了正视图又包含了侧视图。</p>
<p><img src="@source/design/icon/assets/perspective.jpg" alt="不同视角" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/same-weight.jpg" alt="粗细一致" loading="lazy"></p>
<p>在填充图标中，我们会在一个矩形或是圆形中增加矩形的镂空，比如下图的几个图标，在这种情况下也要保证它们的粗细是一致的，而不是各不相同。</p>
<p><img src="@source/design/icon/assets/same-weight2.jpg" alt="粗细一致2" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/size-feel.jpg" alt="尺寸等大的几何形视觉大小并不一致" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/size-adjust.jpg" alt="圆和三角需要进行放大修正" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/weight-feel.jpg" alt="重心感觉" loading="lazy"></p>
<p>如果一个图形其中一部分面积远大于另一部分，那么就会让这个图形的重心产生偏移，必须要往较小的部分的方向移动才能产生平衡。</p>
<p><img src="@source/design/icon/assets/weight-adjust.jpg" alt="调节重心" loading="lazy"></p>
<p>所以，在设计一整套的应用中，如果没有对这个理论的理解，只定义一个矩形出来，把所有图形的尺寸与矩形对齐，那么最终看到的图标效果一定是极度不平衡的。</p>
<p><img src="@source/design/icon/assets/center-compare.jpg" alt="重心对比" loading="lazy"></p>
...
<p>下面是常见的图标栅格:</p>
<p><img src="@source/design/icon/assets/grid.jpg" alt="栅格" loading="lazy"></p>
<p>里面包含了正方形、长方形和圆形。将它们分别罗列出来，可以发现这些图形的视觉尺寸是非常接近的。这样通过该尺寸设计对应的图形，也就看起来都一样大了。</p>
<p><img src="@source/design/icon/assets/grid-compare.jpg" alt="栅格对比" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/grid-usage.jpg" alt="栅格使用" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/old-game.jpg" alt="老游戏" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/subpixel-rendering.jpg" alt="子像素渲染" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/fuzzy.jpg" alt="模糊的边缘" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/AI-align.jpg" alt="AI 对齐" loading="lazy"></p>
