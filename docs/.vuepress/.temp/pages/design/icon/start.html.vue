...
<p><img src="@source/design/icon/assets/ios-grid.jpg" alt="iOS 提供的图标栅格" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-size.jpg" alt="不同的图标大小" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-size2.jpg" alt="不同的图标大小" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-generate.jpg" alt="不同图标生成" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-cut.jpg" alt="图表的剪切" loading="lazy"></p>
<p>如果我们想要设计出正方形图形后预览真实的效果，就可以用我们准备的 PSD 模板，将正方形置入到模板中即可。</p>
<p><img src="@source/design/icon/assets/app-template.jpg" alt="启动图标模板" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-icon2.jpg" alt="图标形式" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-combine.jpg" alt="APP 组合" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-text2.jpg" alt="文字形式" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/font-design.jpg" alt="字体设计" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-tool.jpg" alt="拟物形式" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/app-tool-design.jpg" alt="iOS 文件设计" loading="lazy"></p>
