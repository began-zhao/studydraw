...
<p><img src="@source/design/icon/assets/app-layout.jpg" alt="由图片、文字、几何、图标组成的界面" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/clear-app.jpg" alt="Clear APP 的截图" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/icon-effect.jpg" alt="应用文字替换了图标的对比" loading="lazy"></p>
<p>第二点，就是关于视觉的观赏性。有些页面中，如果把图标去掉了，也丝毫不会影响操作效率，以及对内容的理解。但没有图标，缺少这些点缀，这个页面看起来就会太枯燥，最好的例子就是应用的设置页了，见下方案例。</p>
<p><img src="@source/design/icon/assets/icon-compare.jpg" alt="设置页有图标和没有图标的对比" loading="lazy"></p>
