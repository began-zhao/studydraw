...
<!-- more -->
<p><img src="@source/design/icon/assets/decorate-type.jpg" alt="装饰图标分类" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/KFC.jpg" alt="肯德基设计图" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/KFC-ticket1.jpg" alt="优惠券1" loading="lazy"></p>
<p>但作为装饰图标来说，这样的设计目前有些简陋，左侧空出了大量的留白，所以我们要考虑如何增加细节来丰富这个区域。于是，使用 % 号就可以比较好的标示折扣。</p>
<p><img src="@source/design/icon/assets/KFC-ticket2.jpg" alt="优惠券2" loading="lazy"></p>
<p>最后，开始为图标填色。因为在这套图标中，红色是主要基调，所以我们不能大面积的使用其它颜色，于是就将其中一侧进行留白处理，只修改了它描边的色彩。并且还在票据两侧的连接处添加了一个用来标示阴影的竖线。</p>
<p><img src="@source/design/icon/assets/KFC-ticket3.jpg" alt="优惠券3" loading="lazy"></p>
</li>
<li>
<p>店铺图标</p>
<p><img src="@source/design/icon/assets/shop.jpg" alt="店铺图标" loading="lazy"></p>
</li>
<li>
<p>我的卡包图标</p>
<p><img src="@source/design/icon/assets/wallet.jpg" alt="我的卡包" loading="lazy"></p>
</li>
</ol>
...
<p><img src="@source/design/icon/assets/gradient-background.jpg" alt="渐变几何背景" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/gradient-background2.jpg" alt="渐变几何背景1" loading="lazy"></p>
<p>之后，再在上方置入图标的图形，并为它们添加适当的阴影即可。</p>
<p><img src="@source/design/icon/assets/gradient-background3.jpg" alt="渐变几何背景2" loading="lazy"></p>
<p>如果在这个基础上，还想再添加细节，那么就可以在上方的图形中添加一些折叠的阴影效果，强化立体感。</p>
<p><img src="@source/design/icon/assets/gradient-background4.jpg" alt="渐变几何背景3" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/shine.jpg" alt="炫彩渐变风格" loading="lazy"></p>
...
<p>案例 1:</p>
<p><img src="@source/design/icon/assets/shine1.jpg" alt="炫彩渐变风格1" loading="lazy"></p>
<p>案例 2:</p>
<p><img src="@source/design/icon/assets/shine2.jpg" alt="炫彩渐变风格2" loading="lazy"></p>
<p>案例 3:</p>
<p><img src="@source/design/icon/assets/shine3.jpg" alt="炫彩渐变风格3" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/good.jpg" alt="实物贴图风格" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/good1.jpg" alt="实物贴图风格1" loading="lazy"></p>
</li>
<li>
<p>形体和比例</p>
...
<p><img src="@source/design/icon/assets/good2.jpg" alt="实物贴图风格2" loading="lazy"></p>
</li>
<li>
<p>图形的质感</p>
<p>实物的图形，还有一个非常重要的细节，就是它们的质感。这种质感指的不是物体本身的材质，而是摄影、后期产生的质感。如下图的对比，同一件商品，手机直出的图，和经过商品精修的图，展现出来的质感是完全不一样的。</p>
<p><img src="@source/design/icon/assets/good3.jpg" alt="实物贴图风格3" loading="lazy"></p>
...
<p><img src="@source/design/icon/assets/good4.jpg" alt="实物贴图风格4" loading="lazy"></p>
</li>
</ol>
