...
<p><img src="@source/design/articles/assets/infomation-flow1.jpg" alt="信息流" loading="lazy"></p>
<p>将信息流样式进行简单分类，使用最多的四种样式为纯文、左文右图、短内容、大图视频。如下图所示:</p>
<p><img src="@source/design/articles/assets/infomation-flow2.jpg" alt="信息流" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/infomation-flow3.jpg" alt="信息流" loading="lazy"></p>
<p>三图则通过图片吸引用户点击查看，更加通过图片引导用户点击，好处是可以提升点击率，但是整个信息流显得乱，影响用户阅读。</p>
<p><img src="@source/design/articles/assets/infomation-flow4.jpg" alt="信息流" loading="lazy"></p>
<p>和网易相比，头条信息流阅读起来更加舒服，视觉压力减少，这是基于今日头条三图样式占比很少，如下图所示，网易新闻信息流插入三图样式导致整个信息流杂乱。</p>
<p><img src="@source/design/articles/assets/infomation-flow5.jpg" alt="信息流" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/infomation-flow6.jpg" alt="信息流" loading="lazy"></p>
<p>左文右图，头条的列表比网易的要高一些，对比来看，头条的标题更加明显，图片含有圆角半径，使得头条整体看上去更舒服。</p>
<p><img src="@source/design/articles/assets/infomation-flow7.jpg" alt="信息流" loading="lazy"></p>
<p>大图视频，两者的区别不大，依然是标题文字颜色、封面圆角和发布时间的差异性。</p>
<p><img src="@source/design/articles/assets/infomation-flow8.jpg" alt="信息流" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/infomation-flow9.jpg" alt="信息流" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/infomation-flow10.jpg" alt="信息流" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/infomation-flow11.jpg" alt="信息流" loading="lazy"></p>
<p>标题置于播放器里面，头条可以展示 2.5 条，而好看视频将标题置于外面只能展示 2 条，如下图所示:</p>
<p><img src="@source/design/articles/assets/infomation-flow12.jpg" alt="信息流" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/infomation-flow13.jpg" alt="信息流" loading="lazy"></p>
<p>今日头条的小视频采用和抖音一样的布局。头像和操作项放于右侧。但是为了引导用户评论，在界面底部加入了输入框，引导用户评论，为了让用户更加方便的看评论。上滑手势变成了调起起评论。</p>
<p><img src="@source/design/articles/assets/infomation-flow14.jpg" alt="信息流" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/infomation-flow15.jpg" alt="信息流" loading="lazy"></p>
