...
<p><img src="@source/design/articles/assets/left-or-right-renren.jpg" alt="泳道" loading="lazy"></p>
<p>那么问题来了，究竟向哪个方向滑动呢?</p>
<p>或许您会觉得这是一个送分题，肯定是左滑啊；没错，您去查看 100 个 APP，这种水平横滑的泳道，99 个都是左滑的；但是人人视频就是那唯一的特例，它是左滑和右滑相互组合的。</p>
<p><img src="@source/design/articles/assets/left-or-right-renren.gif" alt="人人交互" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/left-or-right-sight.jpg" alt="视线路径" loading="lazy"></p>
<p>人人视频的这种方案，让我想起夸克浏览器——用户在夸克浏览器里观看视频，如果点击屏幕的位置靠左，那么菜单就会出现在左边；如果点击的位置靠右，菜单就会出现在右边；这样的处理方式，可以缩短用户手指的移动距离。</p>
<p><img src="@source/design/articles/assets/left-or-right-quark.gif" alt="夸克菜单" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/left-or-right-L.jpg" alt="视线移动" loading="lazy"></p>
<p>iOS 11 与 iOS 10 相比，我们可以发现页面标题、搜索框文案和内容都是改成放在左边。</p>
<p><img src="@source/design/articles/assets/left-or-right-app-store.jpg" alt="iOS页面对比" loading="lazy"></p>
<p>整体的视觉动线由中间改成了左边，用户在快速浏览过程中视线不需要发生偏移。</p>
<p><img src="@source/design/articles/assets/left-or-right-app-store2.jpg" alt="iOS 页面对比" loading="lazy"></p>
<p>右代表着更好的易用性。因为在移动端，用户更习惯单手握持手机进行操作；而我们大部分人都是右撇子。</p>
<p>谷歌的 MD 设计中的浮动按钮，是位于界面右侧；微信的浮窗也是位于界面右侧，就是为了方便用户操作。</p>
<p><img src="@source/design/articles/assets/left-or-right-float.jpg" alt="浮动按钮" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/left-or-right-direction.jpg" alt="文字方向" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/left-or-right-flow.jpg" alt="流量分发" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/left-or-right-flow2.jpg" alt="流量分发" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/left-or-right-flow3.jpg" alt="流量分发" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/left-or-right-flow4.jpg" alt="流量分发" loading="lazy"></p>
