...
<p><img src="@source/design/articles/assets/gestalt-principle1.jpg" alt="图片1" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-history.jpg" alt="格式塔原理发展历史" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-move.jpg" alt="似动现象" loading="lazy"></p>
<ul>
<li>
...
<p><img src="@source/design/articles/assets/gestalt-principle-shape.jpg" alt="整体与部分" loading="lazy"></p>
<ul>
<li>
...
<p><img src="@source/design/articles/assets/gestalt-principle-shape2.jpg" alt="整体与部分" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-logo.jpg" alt="这两个品牌logo哪个才是正确的? " loading="lazy"></p>
...
<div class="custom-container info"><p class="custom-container-title">格式塔原理的核心</p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-proximity.jpg" alt="接近性原则" loading="lazy"></p>
<blockquote>
...
<p><img src="@source/design/articles/assets/gestalt-principle-proximity2.jpg" alt="接近性原则" loading="lazy"></p>
<div class="custom-container tip"><p class="custom-container-title">案例</p>
<p><img src="@source/design/articles/assets/gestalt-principle-proximity-app-store.jpg" alt="App Store" loading="lazy"></p>
<p>板块之间的大间距把页面信息分割成各种不同栏目，距离更近的信息暗示了他们有内在的逻辑关系</p>
<p><img src="@source/design/articles/assets/gestalt-principle-proximity-zhanku.jpg" alt="站酷" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-similarity.jpg" alt="相似性原则" loading="lazy"></p>
<p>举个例子相似性原则在实际产品中的应用:</p>
<p><img src="@source/design/articles/assets/gestalt-principle-similarity-bilibili.jpg" alt="bilibili" loading="lazy"></p>
<blockquote>
...
<p><img src="@source/design/articles/assets/gestalt-principle-continuity.jpg" alt="连续性原则" loading="lazy"></p>
<p>△ 左图我们不会认为是两个残缺的圆，而是两个相交的圆；中间的 IBM 商标我们之所以能看出来是 IBM，就是因为我们在视觉上看到的不是离散的线条，而是连续的图形；右图我们会看到是向两个方向连续的曲线。</p>
<div class="custom-container tip"><p class="custom-container-title">案例</p>
<p><img src="@source/design/articles/assets/gestalt-principle-continuity-stock.jpg" alt="股市" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-closure.jpg" alt="闭合性原则" loading="lazy"></p>
<div class="custom-container tip"><p class="custom-container-title">案例</p>
<p><img src="@source/design/articles/assets/gestalt-principle-closure-apple-music.jpg" alt="Apple Music" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-main.jpg" alt="主体/背景原则" loading="lazy"></p>
<div class="custom-container tip"><p class="custom-container-title">案例</p>
<p><img src="@source/design/articles/assets/gestalt-principle-main-doubanFM.jpg" alt="豆瓣 FM" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-simple.jpg" alt="简单对称性原则" loading="lazy"></p>
...
<div class="custom-container tip"><p class="custom-container-title">案例</p>
<p><img src="@source/design/articles/assets/gestalt-principle-simple-pinterest.jpg" alt="Pinterest" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-common-destiny.jpg" alt="共同命运原则" loading="lazy"></p>
<p>向同一方向移动的元素，我们在处理的过程当中，会默认把它们归为一类。</p>
<div class="custom-container tip"><p class="custom-container-title">案例</p>
<p><img src="@source/design/articles/assets/gestalt-principle-common-destiny-iOS.jpg" alt="ios 桌面" loading="lazy"></p>
...
<p><img src="@source/design/articles/assets/gestalt-principle-special.jpg" alt="成员特性律" loading="lazy"></p>
<p>如果我们有很多同样的按钮，如何让某个更重要的按钮突出但是仍然让用户感知还是按钮呢? 那就要用到成员特性律了。成员特性律赋予了集体中某一个元素特殊的一些刺激元素从而突出它。</p>
<p>独特的外形暗示了它与别的元素有不同的功能</p>
<div class="custom-container tip"><p class="custom-container-title">案例</p>
<p><img src="@source/design/articles/assets/gestalt-principle-special-taobao.jpg" alt="淘宝" loading="lazy"></p>
